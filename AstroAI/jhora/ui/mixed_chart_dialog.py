...
class MixedChartOptionsDialog(QDialog):
    ...
    def __init__(
        self, chart_index_1=1, chart_method_1=1, chart_index_2=1, chart_method_2=1
    ):
        super().__init__()
    ...
    def create_ui(self):
        ...
        self._label_1 = QLabel(
            ...
            + "<br>"
            + self.res[_chart_names[self._chart_index_1]]
        )
        ...
        self._method_rbs_1 = [
            QRadioButton("") for _ in range(1, self._method_count_1 + 1)
        ]
        for mc in range(1, self._method_count_1 + 1):
            self._method_rbs_1[mc - 1].setText(
                self.res["d" + str(self._varga_factor_1) + "_option" + str(mc) + "_str"]
            )
            if self._method_index_1 == mc:
                self._method_rbs_1[mc - 1].setChecked(True)
        ...
        self._label_2 = QLabel(
            self.res["varga_option_str"]
            + "<br>"
            + self.res[_chart_names[self._chart_index_2]]
        )
        ...
        self._method_rbs_2 = [
            QRadioButton("") for _ in range(1, self._method_count_2 + 1)
        ]
        for mc in range(1, self._method_count_2 + 1):
            self._method_rbs_2[mc - 1].setText(
                self.res["d" + str(self._varga_factor_2) + "_option" + str(mc) + "_str"]
            )
            if self._method_index_2 == mc:
                self._method_rbs_2[mc - 1].setChecked(True)
        ...
        self.setWindowTitle(
            self.res["mixed_varga_kundali_str"] + " " + self.res["options_str"]
        )
    ...
    def _vargo_combo_1_changed(self):
        ...
        if self._varga_factor_1 == 1:
            self._method_count_1 = None
            self._method_index_1 = None
    ...
    def _vargo_combo_2_changed(self):
        ...
        if self._varga_factor_2 == 1:
            self._method_count_2 = None
            self._method_index_2 = None
    ...
    def _cancel_button_clicked(self):
        ...
        self._option_string_1 = self.res[
            "d"
            + str(self._varga_factor_1)
            + "_option"
            + str(self._method_index_1)
            + "_str"
        ]
        self._option_string_2 = self.res[
            "d"
            + str(self._varga_factor_2)
            + "_option"
            + str(self._method_index_2)
            + "_str"
        ]
        self.reject()
    ...
    def get_mixed_chart(self):
        ...
        pp = charts.mixed_chart(
            jd,
            place,
            self._varga_factor_1,
            self._method_index_1,
            self._varga_factor_2,
            self._method_index_2,
        )

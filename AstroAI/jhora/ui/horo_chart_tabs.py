...
_available_ayanamsa_modes = [
    k
    for k in list(const.available_ayanamsa_modes.keys())
...
south_chart_title_font_size = 12
north_chart_title_font_size = 12
east_chart_title_font_size = 12
west_chart_title_font_size = 10
sudarsana_chakra_chart_title_font_size = 8
...
_chart_names = [
    ...
    "nava_navamsa_str",
    "ashtotharamsa_str",
    "dwadas_dwadasamsa_str",
    "custom_varga_kundali_str",
    "mixed_varga_kundali_str",
]
_custom_chart_index = len(const.division_chart_factors)
_mixed_chart_index = _custom_chart_index + 1
_custom_varga_index = const.DEFAULT_CUSTOM_VARGA_FACTOR
_mixed_chart_index_1 = 8
_mixed_chart_method_1 = 1
_mixed_chart_index_2 = 11
_mixed_chart_method_2 = 1
_bala_names = [
    "amsa_ruler_str",
    "sphuta_str",
    "drishti_str",
    "bhava_graha_arudha_str",
    "vimsopaka_bala_str",
    "vaiseshikamsa_bala_str",
    "harsha_pancha_dwadhasa_vargeeya_bala_str",
    "shad_bala_str",
    "bhava_bala_str",
]
""" dhasa dictionary {"dhasa":[tab_count,table_font_size,tables_per_tab,rows_per_table,cols_per_table] """
_graha_dhasa_dict = {
    "vimsottari": [3, 10, 3, 9, 1, 0, [], []],
    "yoga_vimsottari": [3, 10, 3, 9, 1, 0, [], []],
    "rasi_bhukthi_vimsottari": [3, 10, 3, 12, 1, 0, [], []],
    "ashtottari": [3, 10, 3, 8, 1, 0, [], []],
    "tithi_ashtottari": [3, 10, 3, 8, 1, 0, [], []],
    "yogini": [4, 8, 4, 8, 1, 0, [], []],
    "tithi_yogini": [4, 8, 4, 8, 1, 0, [], []],
    "shodasottari": [2, 8, 4, 8, 1, 0, [], []],
    "dwadasottari": [2, 8, 4, 8, 1, 0, [], []],
    "dwisatpathi": [4, 8, 4, 8, 1, 0, [], []],
    "panchottari": [2, 8, 4, 7, 1, 0, [], []],
    "satabdika": [2, 8, 4, 7, 1, 0, [], []],
    "chaturaaseeti_sama": [2, 8, 4, 7, 1, 0, [], []],
    "karana_chaturaaseeti_sama": [2, 8, 4, 7, 1, 0, [], []],
    "shashtisama": [2, 8, 4, 8, 1, 0, [], []],
    "shattrimsa_sama": [6, 7, 4, 8, 1, 0, [], []],
    "naisargika": [2, 8, 4, 6, 1, 0, [], []],
    "tara": [3, 10, 3, 9, 1, 0, [], []],
    "karaka": [4, 7.5, 4, 8, 1, 0, [], []],
    "buddhi_gathi": [5, 7, 4, 9, 1, 0, [], []],
    "kaala": [6, 8, 3, 18, 1, 0, [], []],
    "aayu": [2, 8, 4, 8, 1, 0, [], []],
    "saptharishi_nakshathra": [3, 8, 3, 11, 1, 0, [], []],
}
_graha_dhasa_names = list(_graha_dhasa_dict.keys())
_graha_dhasa_tab_count = sum(v[0] for k, v in _graha_dhasa_dict.items())
_rasi_dhasa_dict = {
    "narayana": [4, 7, 3, 12, 1, 0, [], []],
    "kendraadhi_rasi": [4, 7, 3, 12, 1, 0, [], []],
    "sudasa": [4, 7, 3, 12, 1, 0, [], []],
    "drig": [3, 8, 4, 12, 1, 0, [], []],
    "nirayana": [4, 7, 3, 12, 1, 0, [], []],
    "shoola": [4, 7, 3, 12, 1, 0, [], []],
    "kendraadhi_karaka": [4, 7, 3, 12, 1, 0, [], []],
    "chara": [4, 7, 3, 12, 1, 0, [], []],
    "lagnamsaka": [4, 7, 3, 12, 1, 0, [], []],
    "padhanadhamsa": [4, 7, 3, 12, 1, 0, [], []],
    "mandooka": [4, 7, 3, 12, 1, 0, [], []],
    "sthira": [4, 7, 3, 12, 1, 0, [], []],
    "tara_lagna": [4, 7, 3, 12, 1, 0, [], []],
    "brahma": [4, 7, 3, 12, 1, 0, [], []],
    "varnada": [4, 7, 3, 12, 1, 0, [], []],
    "yogardha": [4, 7, 3, 12, 1, 0, [], []],
    "navamsa": [3, 7.5, 4, 12, 1, 0, [], []],
    "paryaaya": [3, 7.5, 4, 12, 1, 0, [], []],
    "trikona": [3, 7.5, 4, 12, 1, 0, [], []],
    "kalachakra": [3, 8, 3, 9, 1, 0, [], []],
    "chakra": [3, 7.5, 4, 12, 1, 0, [], []],
    "sandhya_panchaka": [3, 7.5, 4, 12, 1, 0, [], []],
}
_varnada_method_options = [
    "1=>BV Raman",
    "2=>Sharma/Santhanam",
    "3=Sanjay Rath",
    "4=Sitaram Jha",
...
_annual_dhasa_dict = {
    "patyayini": [2, 7.5, 4, 8, 1, 0, [], []],
    "varsha_vimsottari": [3, 9, 3, 9, 1, 0, [], []],
    "varsha_narayana": [5, 7.5, 4, 12, 1, 0, [], []],
}
...
if _EXCLUDE_SAPTHA_NADI_CHARA:
    _available_chakras.remove("saptha_nadi")
...
_amsa_include_upagraha = True
_amsa_include_special_lagna = True
_amsa_include_sphuta = True
...
_vaiseshikamsa_bala_tab_end = (
    _vaiseshikamsa_bala_tab_start + _vaiseshikamsa_bala_tab_count - 1
)
...
_shodhaya_dict = {
    0: "raasi_str",
    7: "navamsam_str",
}  # 2 and 7 are horoscope chart counters
...
class ChartTabbed(QWidget):
    def __init__(
        ...
        show_marriage_compatibility=True,
        ...
        self._chart_type = (
            chart_type
            if chart_type.lower() in const.available_chart_types
            else "south_indian"
        )
        ...
        if gender == None or gender not in [0, 1, 2, 3]:
            self.gender(0)
    ...
    def _hide_2nd_row_widgets(self, show=True):
        ...
        self._years_label.setVisible(show)
        self._months_label.setVisible(show)
        self._60hrs_label.setVisible(show)
        self._years_combo.setVisible(show)
        self._months_combo.setVisible(show)
        self._60hrs_combo.setVisible(show)
    ...
    def _init_tab_widget_ui(self):
        ...
        self.horo_tabs = []
        self._kundali_charts = []
        self._bhava_chart = None
        ...
        self._chart_info_label1 = QLabel("")
        self._chart_info_label2 = QLabel("")
        ...
        if not self._western_chart or "west" not in self._chart_type.lower():
            ...
            t += _dosha_tab_count
            self._init_prediction_tab_widgets(t)
            t += 1
    ...
    def _init_pps_tab_widgets(self, tab_index):
        ...
        self._pps_tree = pancha_pakshi_sastra_widget.PanchaPakshiSastraWidget(
            synch_with_local_clock=True
        )
    ...
    def _init_compatibility_tab_widgets(self, tab_index):
        ...
        h_layout = QHBoxLayout()
        self._matching_star_list = QListWidget()
        self._matching_star_list.currentRowChanged.connect(
            self._update_compatibility_table
        )
        self._matching_star_list.setSelectionMode(
            QAbstractItemView.SelectionMode.SingleSelection
        )
        ...
        for c in range(_comp_results_per_list_item):
            ...
            self._comp_results_table[c].setStyleSheet(
                "font-size:" + str(_comp_table_font_size) + "pt"
            )
            self._comp_results_table[c].verticalHeader().hide()
            self._comp_results_table[c].setHorizontalHeaderItem(
                0, QTableWidgetItem("Porutham/Koota")
            )
            self._comp_results_table[c].setHorizontalHeaderItem(
                1, QTableWidgetItem("Score")
            )
            self._comp_results_table[c].setHorizontalHeaderItem(
                2, QTableWidgetItem("Max Score")
            )
            self._comp_results_table[c].setHorizontalHeaderItem(
                3, QTableWidgetItem("%")
            )
            self._comp_results_table[c].setEditTriggers(
                QAbstractItemView.EditTrigger.NoEditTriggers
            )
            self._comp_results_table[c].setSizeAdjustPolicy(
                QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents
            )
    ...
    def _init_amsa_ruler_tab_widgets(self, tab_index):
        ...
        _amsa_ruler_list = [
            _chart_names[const.division_chart_factors.index(ak)]
            for ak in self._amsa_vargas[:-1]
        ] + ["naadiamsha_str"]
        self._amsa_chart_combo.addItems(_amsa_ruler_list)
        self._current_amsa_chart_index = 12
        ...
        self._amsa_option_info_label.setStyleSheet(
            "border: 2px solid black;font-size:12px; font-weight:bold;"
        )
        ...
        upagraha_count = len(const._solar_upagraha_list) + len(
            const._other_upagraha_list
        )
        ...
        self._amsa_ruler_table1.setStyleSheet(
            "font-size:" + str(_amsa_ruler_table_font_size) + "pt"
        )
        self._amsa_ruler_table1.horizontalHeader().setVisible(False)
        self._amsa_ruler_table1.verticalHeader().setVisible(False)
        self._amsa_ruler_table1.setSizeAdjustPolicy(
            QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents
        )
        delegate = AlignDelegate(self._amsa_ruler_table1)
        self._amsa_ruler_table1.setItemDelegate(delegate)
        self._amsa_ruler_table1.setVerticalScrollBarPolicy(
            Qt.ScrollBarPolicy.ScrollBarAlwaysOff
        )
        self._amsa_ruler_table1.setHorizontalScrollBarPolicy(
            Qt.ScrollBarPolicy.ScrollBarAlwaysOff
        )
        h_layout = QHBoxLayout()
        ...
        if _amsa_include_special_lagna:
            ...
            self._amsa_ruler_table2.setStyleSheet(
                "font-size:" + str(_amsa_ruler_table_font_size) + "pt"
            )
            self._amsa_ruler_table2.horizontalHeader().setVisible(False)
            self._amsa_ruler_table2.verticalHeader().setVisible(False)
            self._amsa_ruler_table2.setSizeAdjustPolicy(
                QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents
            )
            delegate = AlignDelegate(self._amsa_ruler_table2)
            self._amsa_ruler_table2.setItemDelegate(delegate)
            self._amsa_ruler_table2.setVerticalScrollBarPolicy(
                Qt.ScrollBarPolicy.ScrollBarAlwaysOff
            )
            self._amsa_ruler_table2.setHorizontalScrollBarPolicy(
                Qt.ScrollBarPolicy.ScrollBarAlwaysOff
            )
            h_layout.addWidget(self._amsa_ruler_table2)
        if _amsa_include_upagraha:
            self._amsa_ruler_table3 = QTableWidget(upagraha_count, 2)
            self._amsa_ruler_table3.setStyleSheet(
                "font-size:" + str(_amsa_ruler_table_font_size) + "pt"
            )
            self._amsa_ruler_table3.horizontalHeader().setVisible(False)
            self._amsa_ruler_table3.verticalHeader().setVisible(False)
            self._amsa_ruler_table3.setSizeAdjustPolicy(
                QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents
            )
            delegate = AlignDelegate(self._amsa_ruler_table3)
            self._amsa_ruler_table3.setItemDelegate(delegate)
            self._amsa_ruler_table3.setVerticalScrollBarPolicy(
                Qt.ScrollBarPolicy.ScrollBarAlwaysOff
            )
            self._amsa_ruler_table3.setHorizontalScrollBarPolicy(
                Qt.ScrollBarPolicy.ScrollBarAlwaysOff
            )
            h_layout.addWidget(self._amsa_ruler_table3)
        if _amsa_include_sphuta:
            self._amsa_ruler_table4 = QTableWidget(sphuta_count, 2)
            self._amsa_ruler_table4.setStyleSheet(
                "font-size:" + str(_amsa_ruler_table_font_size) + "pt"
            )
            self._amsa_ruler_table4.horizontalHeader().setVisible(False)
            self._amsa_ruler_table4.verticalHeader().setVisible(False)
            self._amsa_ruler_table4.setSizeAdjustPolicy(
                QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents
            )
            delegate = AlignDelegate(self._amsa_ruler_table4)
            self._amsa_ruler_table4.setItemDelegate(delegate)
            self._amsa_ruler_table4.setVerticalScrollBarPolicy(
                Qt.ScrollBarPolicy.ScrollBarAlwaysOff
            )
            self._amsa_ruler_table4.setHorizontalScrollBarPolicy(
                Qt.ScrollBarPolicy.ScrollBarAlwaysOff
            )
            h_layout.addWidget(self._amsa_ruler_table4)
        v_layout.addLayout(h_layout)
        self._amsa_chart_combo.currentIndexChanged.connect(
        ...
        self._amsa_varga_dict = {
            k: v
            for k, v in varga_chart_dialog.get_varga_option_dict().items()
            if k in self._amsa_vargas
        }
    ...
    def _show_amsa_chart_options(self):
        ...
        if self._current_amsa_chart_index == len(self._amsa_vargas) - 1:
            self._amsa_chart_options_str = self.resources[
                "dn_custom_option" + str(self._amsa_method_index) + "_str"
            ]
        else:
            self._amsa_chart_options_str = self.resources[
                "d"
                + str(varga_index)
                + "_option"
                + str(self._amsa_method_index)
                + "_str"
            ]
        dlg = varga_chart_dialog.VargaChartOptionsDialog(
            varga_factor=varga_index,
        ...
        if dlg.exec() == 1:
            ...
            if dlg._varga_factor != None:
                varga_index = dlg._varga_factor
            self._amsa_varga_dict[varga_index] = (
                self._amsa_varga_dict[varga_index][0],
                self._amsa_method_index,
                dlg._base_rasi_index,
                dlg._count_from_end_of_sign,
            )
    ...
    def _amsa_chart_selection_changed(self):
        ...
        self._amsa_chart_option_button.setText(
            self._amsa_chart_combo.currentText() + " " + self.resources["options_str"]
        )
        self._amsa_option_info_label.setText(self._amsa_chart_options_str)
        self._amsa_option_info_label.adjustSize()
        self._update_amsa_ruler_tab_information(
            self._current_amsa_chart_index, self._amsa_method_index
        )
    ...
    def _init_sphuta_tab_widgets(self, tab_index):
        ...
        self._sphuta_chart_combo.currentIndexChanged.connect(
        ...
        self._sphuta_chart_option_button.clicked.connect(
            self._show_sphuta_chart_options
        )
        ...
        self._sphuta_option_info_label.setStyleSheet(
            "border: 2px solid black;font-size:12px; font-weight:bold;"
        )
        ...
        self._varnada_option_button.setStyleSheet(
            "border: 2px solid black;font-size:12px; font-weight:bold;"
        )
        ...
        self._varnada_option_info_label.setStyleSheet(
            "border: 2px solid black;font-size:12px; font-weight:bold;"
        )
        ...
        self._sphuta_table.setStyleSheet(
            "font-size:" + str(_sphuta_table_font_size) + "pt"
        )
        self._sphuta_table.verticalHeader().setVisible(False)
        self._sphuta_table.setVerticalScrollBarPolicy(
            Qt.ScrollBarPolicy.ScrollBarAlwaysOff
        )
        h_layout1.addWidget(self._sphuta_table)
        self._varnada_table = QTableWidget(12, 2)
        self._varnada_table.setStyleSheet(
            "font-size:" + str(_sphuta_table_font_size) + "pt"
        )
        self._varnada_table.verticalHeader().setVisible(False)
        self._varnada_table.setVerticalScrollBarPolicy(
            Qt.ScrollBarPolicy.ScrollBarAlwaysOff
        )
        ...
        self._varnada_varga_dict = {
            dcf: 1 for dcf in [1] + list(self._sphuta_varga_dict.keys())
        }
        ...
        self._sphuta_custom_varga = _custom_varga_index
        self._sphuta_mixed_chart_index_1 = _mixed_chart_index_1
        self._sphuta_mixed_chart_index_2 = _mixed_chart_index_2
        self._sphuta_mixed_method_index_1 = _mixed_chart_method_1
        self._sphuta_mixed_method_index_2 = _mixed_chart_method_2
    ...
    def _show_varnada_options(self):
        ...
        self._varnada_option_info_label.setText(
            _varnada_method_options[self._varnada_method_index - 1]
        )
        dlg = options_dialog.OptionDialog(
            title="Varnada Options",
            option_label="Select Varnatha Lagna options from",
            options_list=_varnada_method_options,
            default_options=self._varnada_method_index - 1,
        ...
        if dlg.exec() == 1:
            ...
            if self._current_sphuta_chart_index == _mixed_chart_index:
                self._update_sphuta_tab_information(
                    ...
                    chart_index_1=self._sphuta_mixed_chart_index_1,
                    chart_method_1=self._sphuta_mixed_method_index_1,
                    chart_index_2=self._sphuta_mixed_chart_index_2,
                    chart_method_2=self._sphuta_mixed_method_index_2,
                )
            else:
                self._update_sphuta_tab_information(
                    chart_index=self._current_sphuta_chart_index,
    ...
    def _show_sphuta_chart_options(self):
        ...
        if self._current_sphuta_chart_index < _custom_chart_index:
            ...
            self._sphuta_chart_options_str = self.resources[
                "d"
                + str(varga_index)
                + "_option"
                + str(self._sphuta_method_index)
                + "_str"
            ]
            ...
            self._sphuta_method_index = self._sphuta_varga_dict[varga_index][1]
            self._sphuta_chart_options_str = self.resources[
                "dn_custom_option" + str(self._sphuta_method_index) + "_str"
            ]
            ...
            v1s = self.resources[
                ...
                + str(v1)
                + "_option"
                + str(self._sphuta_mixed_method_index_1)
                + "_str"
            ]
            v2s = self.resources[
                "d"
                + str(v2)
                + "_option"
                + str(self._sphuta_mixed_method_index_2)
                + "_str"
            ]
            self._sphuta_chart_options_str = (
                "D" + str(v1) + ":" + v1s + "<br>" + "D" + str(v2) + ":" + v2s
            )
        if self._current_sphuta_chart_index <= _custom_chart_index:
            dlg = varga_chart_dialog.VargaChartOptionsDialog(
                chart_index=self._current_sphuta_chart_index,
                chart_method=self._sphuta_method_index,
                varga_factor=varga_index,
                base_rasi=self._sphuta_varga_dict[varga_index][2],
                count_from_end_of_sign=self._sphuta_varga_dict[varga_index][3],
            )
            if dlg.exec() == 1:
                ...
                if dlg._varga_factor != None:
                    varga_index = dlg._varga_factor
                if self._current_sphuta_chart_index == _custom_chart_index:
                    self._sphuta_custom_varga = varga_index
                self._sphuta_varga_dict[varga_index] = (
                    self._sphuta_varga_dict[varga_index][0],
                    dlg._method_index,
                    dlg._base_rasi_index,
                    dlg._count_from_end_of_sign,
                )
            ...
            self._sphuta_option_info_label.setText(self._sphuta_chart_options_str)
            dlg = mixed_chart_dialog.MixedChartOptionsDialog(
                chart_index_1=self._sphuta_mixed_chart_index_1,
                chart_index_2=self._sphuta_mixed_chart_index_2,
                chart_method_1=self._sphuta_mixed_method_index_1,
                chart_method_2=self._sphuta_mixed_method_index_2,
            ...
            if dlg.exec() == 1:
                self._sphuta_mixed_chart_index_1 = dlg._chart_index_1
                self._sphuta_mixed_chart_index_2 = dlg._chart_index_2
                self._sphuta_mixed_method_index_1 = dlg._method_index_1
                self._sphuta_mixed_method_index_2 = dlg._method_index_2
                v1 = dlg._varga_factor_1
                v2 = dlg._varga_factor_2
                v1s = self.resources[
                    "d"
                    + str(v1)
                    + "_option"
                ...
                self._sphuta_chart_option_button.setText(
                    mds + self.resources["options_str"]
                )
                self._update_sphuta_tab_information(
                    chart_index=self._current_sphuta_chart_index,
                    varnada_method_index=self._varnada_method_index,
                    chart_index_1=dlg._chart_index_1,
                    chart_method_1=dlg._method_index_1,
                    chart_index_2=dlg._chart_index_2,
                    chart_method_2=dlg._method_index_2,
                )
    ...
    def _sphuta_chart_selection_changed(self):
        ...
        if self._current_sphuta_chart_index == 0:
            self._sphuta_chart_option_button.setEnabled(False)
            self._sphuta_chart_option_button.setVisible(False)
            self._sphuta_option_info_label.setEnabled(False)
            self._sphuta_option_info_label.setVisible(False)
        else:
            self._sphuta_chart_option_button.setEnabled(True)
            self._sphuta_chart_option_button.setVisible(True)
            self._sphuta_option_info_label.setEnabled(True)
            self._sphuta_option_info_label.setVisible(True)
        if self._current_sphuta_chart_index == _mixed_chart_index:
            mds = "D" + str(v1) + "xD" + str(v2) + " "
            self._sphuta_chart_option_button.setText(
                mds + self.resources["options_str"]
            ...
            self._sphuta_chart_option_button.setText(
                ...
                + " "
                + self.resources["options_str"]
            )
            if self._current_sphuta_chart_index == _custom_chart_index:
                self._sphuta_chart_option_button.setText(
                    "D" + str(varga_index) + " " + self.resources["options_str"]
                )
            self._update_sphuta_tab_information(
                chart_index=self._current_sphuta_chart_index,
                method_index=self._sphuta_method_index,
    ...
    def _init_graha_arudha_tab_widgets(self, tab_index):
        ...
        self._arudha_chart_combo.currentIndexChanged.connect(
        ...
        self._arudha_chart_option_button.clicked.connect(
            self._show_arudha_chart_options
        )
        ...
        self._arudha_option_info_label.setStyleSheet(
            "border: 2px solid black;font-size:12px; font-weight:bold;"
        )
        self._arudha_option_info_label.setEnabled(False)
        self._arudha_option_info_label.setSizePolicy(
        ...
        self._bhava_arudha_combo.currentIndexChanged.connect(
            self._graha_arudha_chart_selection_changed
        )
        ...
        self._graha_arudha_table.setStyleSheet(
            "font-size:" + str(_arudha_table_font_size) + "pt"
        )
        self._graha_arudha_table.horizontalHeader().setVisible(False)
        self._graha_arudha_table.verticalHeader().setVisible(False)
        h_layout1.addWidget(self._graha_arudha_table)
        self._bhava_arudha_table = QTableWidget(12, 2)
        self._bhava_arudha_table.setStyleSheet(
            "font-size:" + str(_arudha_table_font_size) + "pt"
        )
        self._bhava_arudha_table.horizontalHeader().setVisible(False)
        self._bhava_arudha_table.verticalHeader().setVisible(False)
        ...
        self._arudha_mixed_chart_index_1 = _mixed_chart_index_1
        self._arudha_mixed_chart_index_2 = _mixed_chart_index_2
        self._arudha_mixed_method_index_1 = _mixed_chart_method_1
        self._arudha_mixed_method_index_2 = _mixed_chart_method_2
    ...
    def _show_arudha_chart_options(self):
        ...
        if self._current_arudha_chart_index < _custom_chart_index:
            ...
            self._arudha_chart_options_str = self.resources[
                "d"
                + str(varga_index)
                + "_option"
                + str(self._arudha_method_index)
                + "_str"
            ]
            ...
            self._arudha_method_index = self._arudha_varga_dict[varga_index][1]
            self._arudha_chart_options_str = self.resources[
                "dn_custom_option" + str(self._arudha_method_index) + "_str"
            ]
            ...
            v1s = self.resources[
                ...
                + str(v1)
                + "_option"
                + str(self._arudha_mixed_method_index_1)
                + "_str"
            ]
            v2s = self.resources[
                "d"
                + str(v2)
                + "_option"
                + str(self._arudha_mixed_method_index_2)
                + "_str"
            ]
        ...
        if self._current_arudha_chart_index <= _custom_chart_index:
            dlg = varga_chart_dialog.VargaChartOptionsDialog(
                chart_index=self._current_arudha_chart_index,
                chart_method=self._arudha_method_index,
                varga_factor=varga_index,
                base_rasi=self._arudha_varga_dict[self._arudha_custom_varga][2],
                count_from_end_of_sign=self._arudha_varga_dict[
                    self._arudha_custom_varga
                ][3],
            )
            if dlg.exec() == 1:
                ...
                if dlg._varga_factor != None:
                    varga_index = dlg._varga_factor
                if self._current_arudha_chart_index == _custom_chart_index:
                    self._arudha_custom_varga = varga_index
                self._arudha_varga_dict[varga_index] = (
                    self._arudha_varga_dict[varga_index][0],
                    dlg._method_index,
                    dlg._base_rasi_index,
                    dlg._count_from_end_of_sign,
                )
            ...
            self._arudha_option_info_label.setText(self._arudha_chart_options_str)
            dlg = mixed_chart_dialog.MixedChartOptionsDialog(
                chart_index_1=self._arudha_mixed_chart_index_1,
                chart_index_2=self._arudha_mixed_chart_index_2,
                chart_method_1=self._arudha_mixed_method_index_1,
                chart_method_2=self._arudha_mixed_method_index_2,
            )
            if dlg.exec() == 1:
                self._arudha_mixed_chart_index_1 = dlg._chart_index_1
                self._arudha_mixed_chart_index_2 = dlg._chart_index_2
                self._arudha_mixed_method_index_1 = dlg._method_index_1
                self._arudha_mixed_method_index_2 = dlg._method_index_2
                v1 = dlg._varga_factor_1
                v2 = dlg._varga_factor_2
                v1s = self.resources[
                    "d"
                ...
                self._arudha_option_info_label.setText(self._arudha_chart_options_str)
                mds = "D" + str(v1) + "xD" + str(v2) + " "
                self._arudha_chart_option_button.setText(
                    mds + self.resources["options_str"]
                )
                self._update_graha_arudha_tab_information(
                    chart_index=self._current_arudha_chart_index,
    ...
    def _graha_arudha_chart_selection_changed(self):
        ...
        if self._current_arudha_chart_index == 0:
            self._arudha_chart_option_button.setEnabled(False)
            self._arudha_chart_option_button.setVisible(False)
            self._arudha_option_info_label.setEnabled(False)
            self._arudha_option_info_label.setVisible(False)
        else:
            self._arudha_chart_option_button.setEnabled(True)
            self._arudha_chart_option_button.setVisible(True)
            self._arudha_option_info_label.setEnabled(True)
            self._arudha_option_info_label.setVisible(True)
        if self._current_arudha_chart_index == _mixed_chart_index:
            ...
            self._arudha_chart_option_button.setText(
                self._arudha_chart_combo.currentText()
                + " "
                + self.resources["options_str"]
            )
            if self._current_arudha_chart_index == _custom_chart_index:
    ...
    def _init_vimsopaka_bala_tab_widgets(self, tab_index):
        ...
        self.vimsopaka_bala_db_tables = self._init_dhasa_tab_widgets(
            tab_index,
            self._vimsopaka_bala_tables_per_tab,
            self._vimsopaka_bala_rows_per_table,
            self._vimsopaka_bala_cols_per_table,
            _vimsopaka_bala_tab_start,
            _vimsopaka_bala_tab_count,
            "vimsopaka_bala_str",
            _vimsopaka_bala_table_font_size,
        )
        return
    ...
    def _init_vaiseshikamsa_bala_tab_widgets(self, tab_index):
        ...
        self.vaiseshikamsa_bala_db_tables = self._init_dhasa_tab_widgets(
            tab_index,
            self._vaiseshikamsa_bala_tables_per_tab,
            self._vaiseshikamsa_bala_rows_per_table,
            self._vaiseshikamsa_bala_cols_per_table,
            _vaiseshikamsa_bala_tab_start,
            _vaiseshikamsa_bala_tab_count,
            "vaiseshikamsa_bala_str",
            _vaiseshikamsa_bala_table_font_size,
        )
        return
    ...
    def _init_other_bala_tab_widgets(self, tab_index):
        ...
        self.other_bala_db_tables = self._init_dhasa_tab_widgets(
            tab_index,
            self._other_bala_tables_per_tab,
            self._other_bala_rows_per_table,
            self._other_bala_cols_per_table,
            _other_bala_tab_start,
            _other_bala_tab_count,
            "harsha_pancha_dwadhasa_vargeeya_bala_str",
            _other_bala_table_font_size,
        )
        return
    ...
    def _init_dhasa_tab_widgets_new(self, tab_index):
        ...
        self._dhasa_options_button.setStyleSheet(
            "border: 2px solid black;font-size:12px; font-weight:bold;"
        )
        ...
        self._dhasa_option_info_label.setStyleSheet(
            "border: 2px solid black;font-size:12px; font-weight:bold;"
        )
    ...
    def _dhasa_type_selection_changed(self):
        ...
        self._dhasa_option_info_label.setText(
            self._dhasa_bhukthi_options_str[self._current_dhasa_index]
        )  # RESET option status
        if self.resources != None:
            ...
            if self._dhasa_type_combo.currentIndex() == 0:
                ...
                self._dhasa_varga_combo.setVisible(False)
                _dhasa_list = [
                    self.resources[d + "_str"] for d in list(_graha_dhasa_dict.keys())
                ]
                self._dhasa_combo.addItems(_dhasa_list)
                self._dhasa_combo.setCurrentIndex(self._current_dhasa_index) if (
                    self._current_dhasa_index >= 0
                    and self._current_dhasa_index < len(_graha_dhasa_dict)
                ) else 0
                self._dhasa_options_button.setText(
                ...
                _dhasa_list = [
                    self.resources[d + "_str"] for d in list(_rasi_dhasa_dict.keys())
                ]
                self._dhasa_combo.addItems(_dhasa_list)
                self._dhasa_combo.setCurrentIndex(self._current_dhasa_index) if (
                    self._current_dhasa_index >= 0
                    and self._current_dhasa_index < len(_rasi_dhasa_dict)
                ) else 0
            else:
                self._dhasa_options_button.setVisible(False)
                self._dhasa_varga_combo.setVisible(True)
                _dhasa_list = [
                    self.resources[d + "_str"] for d in list(_annual_dhasa_dict.keys())
                ]
                self._dhasa_combo.addItems(_dhasa_list)
                self._dhasa_combo.setCurrentIndex(self._current_dhasa_index) if (
                    self._current_dhasa_index >= 0
                    and self._current_dhasa_index < len(_annual_dhasa_dict)
                ) else 0
    ...
    def _init_dhasa_tab_widgets(
        ...
        _db_tables = [
            [
                QTableWidget(rows_per_table, cols_per_table)
                for _ in range(tables_per_tab)
            ]
        ...
        for db_tab in range(tab_count):
            ...
            for col in range(tables_per_tab):
                ...
                _db_tables[db_tab][col].setStyleSheet(
                    "font-size:" + str(table_font_size) + "pt"
                )
                _db_tables[db_tab][col].setVerticalScrollBarPolicy(
                    Qt.ScrollBarPolicy.ScrollBarAlwaysOff
                )
                _db_tables[db_tab][col].setHorizontalScrollBarPolicy(
                    Qt.ScrollBarPolicy.ScrollBarAlwaysOff
                )
    ...
    def _init_bhaava_tab_widgets(self, tab_index):
        ...
        self._bhava_chart_type = (
            "south_indian" if "west" in self._chart_type.lower() else self._chart_type
        )
        self._western_chart = True if "west" in self._chart_type.lower() else False
        self._bhava_chart = available_chart_types[self._bhava_chart_type](
            chart_size_factor=_bhava_chart_size_factor,
            label_font_size=_chart_label_font_size,
        )
        self._bhava_table_rows = 13
        self._bhava_table_columns = 5
        self._bhava_table = LabelGrid(
            rows=self._bhava_table_rows,
            columns=self._bhava_table_columns,
            label_font_size=10,
        ...
        self._bhaava_madhya_method = list(const.available_house_systems.keys())[
            _bhava_value_index
        ]
    ...
    def _init_chakra_tab_widgets(self, tab_index):
        ...
        self._chakra_chart_combo.currentIndexChanged.connect(
        ...
        self._chakra_chart_option_button.clicked.connect(
            self._show_chakra_chart_options
        )
        ...
        self._chakra_option_info_label.setStyleSheet(
            "border: 2px solid black;font-size:12px; font-weight:bold;"
        )
        self._chakra_option_info_label.setEnabled(False)
        self._chakra_option_info_label.setSizePolicy(
            QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed
        )
        ...
        self._chakra_options_group.buttonClicked.connect(
            self._chakra_chart_selection_changed
        )
        v_layout.addLayout(h_layout1)
        self._chakra_info_label = QLabel("")
        v_layout.addWidget(self._chakra_info_label)
        self._chakra_widget = QStackedWidget()
        self._chakra_widget.addWidget(QWidget())
        ...
        self._chakra_mixed_chart_index_1 = _mixed_chart_index_1
        self._chakra_mixed_chart_index_2 = _mixed_chart_index_2
        self._chakra_mixed_method_index_1 = _mixed_chart_method_1
        self._chakra_mixed_method_index_2 = _mixed_chart_method_2
    ...
    def _show_chakra_chart_options(self):
        ...
        if self._current_chakra_chart_index < _custom_chart_index:
            ...
            self._chakra_chart_options_str = self.resources[
                "d"
                + str(varga_index)
                + "_option"
                + str(self._chakra_method_index)
                + "_str"
            ]
            ...
            self._chakra_method_index = self._chakra_varga_dict[varga_index][1]
            self._chakra_chart_options_str = self.resources[
                "dn_custom_option" + str(self._chakra_method_index) + "_str"
            ]
            ...
            v1s = self.resources[
                ...
                + str(v1)
                + "_option"
                + str(self._chakra_mixed_method_index_1)
                + "_str"
            ]
            v2s = self.resources[
                "d"
                + str(v2)
                + "_option"
                + str(self._chakra_mixed_method_index_2)
                + "_str"
            ]
        ...
        if self._current_chakra_chart_index <= _custom_chart_index:
            dlg = varga_chart_dialog.VargaChartOptionsDialog(
                ...
                count_from_end_of_sign=self._chakra_varga_dict[
                    self._chakra_custom_varga
                ][3],
            )
            if dlg.exec() == 1:
                ...
                if dlg._varga_factor != None:
                    varga_index = dlg._varga_factor
                if self._current_chakra_chart_index == _custom_chart_index:
                    self._chakra_custom_varga = varga_index
                self._chakra_varga_dict[varga_index] = (
                    self._chakra_varga_dict[varga_index][0],
                    dlg._method_index,
                    dlg._base_rasi_index,
                    dlg._count_from_end_of_sign,
                )
            ...
            self._chakra_option_info_label.setText(self._chakra_chart_options_str)
            dlg = mixed_chart_dialog.MixedChartOptionsDialog(
                chart_index_1=self._chakra_mixed_chart_index_1,
                chart_index_2=self._chakra_mixed_chart_index_2,
                chart_method_1=self._chakra_mixed_method_index_1,
                chart_method_2=self._chakra_mixed_method_index_2,
            )
            if dlg.exec() == 1:
                self._chakra_mixed_chart_index_1 = dlg._chart_index_1
                self._chakra_mixed_chart_index_2 = dlg._chart_index_2
                self._chakra_mixed_method_index_1 = dlg._method_index_1
                self._chakra_mixed_method_index_2 = dlg._method_index_2
                v1 = dlg._varga_factor_1
                v2 = dlg._varga_factor_2
                v1s = self.resources[
                    "d"
                ...
                self._chakra_option_info_label.setText(self._chakra_chart_options_str)
                mds = "D" + str(v1) + "xD" + str(v2) + " "
                self._chakra_chart_option_button.setText(
                    mds + self.resources["options_str"]
                )
                self._update_chakra_tab_information(
                    chart_index=self._current_chakra_chart_index,
    ...
    def _chakra_chart_selection_changed(self):
        ...
        if self._current_chakra_chart_index == 0:
            self._chakra_chart_option_button.setEnabled(False)
            self._chakra_chart_option_button.setVisible(False)
            self._chakra_option_info_label.setEnabled(False)
            self._chakra_option_info_label.setVisible(False)
        else:
            self._chakra_chart_option_button.setEnabled(True)
            self._chakra_chart_option_button.setVisible(True)
            self._chakra_option_info_label.setEnabled(True)
            self._chakra_option_info_label.setVisible(True)
        if self._current_chakra_chart_index == _mixed_chart_index:
            ...
            self._chakra_chart_option_button.setText(
                self._chakra_chart_combo.currentText()
                + " "
                + self.resources["options_str"]
            )
            if self._current_chakra_chart_index == _custom_chart_index:
    ...
    def _init_kpinfo_tab_widgets(self, tab_index):
        ...
        self._kpinfo_chart_combo.currentIndexChanged.connect(
        ...
        self._kpinfo_chart_option_button.clicked.connect(
            self._show_kpinfo_chart_options
        )
        ...
        self._kpinfo_option_info_label.setStyleSheet(
            "border: 2px solid black;font-size:12px; font-weight:bold;"
        )
        self._kpinfo_option_info_label.setEnabled(False)
        self._kpinfo_option_info_label.setSizePolicy(
            QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed
        )
        ...
        self._kpinfo_table.setStyleSheet(
            "font-size:" + str(_kpinfo_label_font_size) + "pt"
        )
        self._kpinfo_table.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        self._kpinfo_table.setSizeAdjustPolicy(
            QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents
        )
        ...
        self._kpinfo_mixed_chart_index_1 = _mixed_chart_index_1
        self._kpinfo_mixed_chart_index_2 = _mixed_chart_index_2
        self._kpinfo_mixed_method_index_1 = _mixed_chart_method_1
        self._kpinfo_mixed_method_index_2 = _mixed_chart_method_2
        self.horo_tabs[tab_index].setLayout(v_layout)
    ...
    def _show_kpinfo_chart_options(self):
        ...
        if self._current_kpinfo_chart_index < _custom_chart_index:
            ...
            self._kpinfo_chart_options_str = self.resources[
                "d"
                + str(varga_index)
                + "_option"
                + str(self._kpinfo_method_index)
                + "_str"
            ]
            ...
            self._kpinfo_method_index = self._kpinfo_varga_dict[varga_index][1]
            self._kpinfo_chart_options_str = self.resources[
                "dn_custom_option" + str(self._kpinfo_method_index) + "_str"
            ]
            ...
            v1s = self.resources[
                ...
                + str(v1)
                + "_option"
                + str(self._kpinfo_mixed_method_index_1)
                + "_str"
            ]
            v2s = self.resources[
                "d"
                + str(v2)
                + "_option"
                + str(self._kpinfo_mixed_method_index_2)
                + "_str"
            ]
        ...
        if self._current_kpinfo_chart_index <= _custom_chart_index:
            dlg = varga_chart_dialog.VargaChartOptionsDialog(
                ...
                count_from_end_of_sign=self._kpinfo_varga_dict[
                    self._kpinfo_custom_varga
                ][3],
            )
            if dlg.exec() == 1:
                ...
                if dlg._varga_factor != None:
                    varga_index = dlg._varga_factor
                if self._current_kpinfo_chart_index == _custom_chart_index:
                    self._kpinfo_custom_varga = varga_index
                self._kpinfo_varga_dict[varga_index] = (
                    self._kpinfo_varga_dict[varga_index][0],
                    dlg._method_index,
                    dlg._base_rasi_index,
                    dlg._count_from_end_of_sign,
                )
            ...
            self._kpinfo_option_info_label.setText(self._kpinfo_chart_options_str)
            dlg = mixed_chart_dialog.MixedChartOptionsDialog(
                chart_index_1=self._kpinfo_mixed_chart_index_1,
                chart_index_2=self._kpinfo_mixed_chart_index_2,
                chart_method_1=self._kpinfo_mixed_method_index_1,
                chart_method_2=self._kpinfo_mixed_method_index_2,
            )
            if dlg.exec() == 1:
                self._kpinfo_mixed_chart_index_1 = dlg._chart_index_1
                self._kpinfo_mixed_chart_index_2 = dlg._chart_index_2
                self._kpinfo_mixed_method_index_1 = dlg._method_index_1
                self._kpinfo_mixed_method_index_2 = dlg._method_index_2
                v1 = dlg._varga_factor_1
                v2 = dlg._varga_factor_2
                v1s = self.resources[
                    "d"
                ...
                self._kpinfo_option_info_label.setText(self._kpinfo_chart_options_str)
                mds = "D" + str(v1) + "xD" + str(v2) + " "
                self._kpinfo_chart_option_button.setText(
                    mds + self.resources["options_str"]
                )
                self._update_kpinfo_information(
                    chart_index=self._current_kpinfo_chart_index,
    ...
    def _kpinfo_chart_selection_changed(self):
        ...
        if self._current_kpinfo_chart_index == 0:
            self._kpinfo_chart_option_button.setEnabled(False)
            self._kpinfo_chart_option_button.setVisible(False)
            self._kpinfo_option_info_label.setEnabled(False)
            self._kpinfo_option_info_label.setVisible(False)
        else:
            self._kpinfo_chart_option_button.setEnabled(True)
            self._kpinfo_chart_option_button.setVisible(True)
            self._kpinfo_option_info_label.setEnabled(True)
            self._kpinfo_option_info_label.setVisible(True)
        if self._current_kpinfo_chart_index == _mixed_chart_index:
            ...
            self._kpinfo_chart_option_button.setText(
                self._kpinfo_chart_combo.currentText()
                + " "
                + self.resources["options_str"]
            )
            if self._current_kpinfo_chart_index == _custom_chart_index:
    ...
    def _init_chart_tab_widgets(self, tab_index):
        ...
        self._kundali_chart_combo.currentIndexChanged.connect(
        ...
        self._kundali_chart_option_button.clicked.connect(
            self._show_kundali_chart_options
        )
        ...
        self._kundali_option_info_label.setStyleSheet(
            "border: 2px solid black;font-size:12px; font-weight:bold;"
        )
        self._kundali_option_info_label.setEnabled(False)
        self._kundali_option_info_label.setSizePolicy(
            QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed
        )
        ...
        self.tabWidget.addTab(
            self.horo_tabs[tab_index + c], self.tabNames[tab_index + c]
        )
        h_layout = QHBoxLayout()
        self._kundali_charts.append(
            available_chart_types[self._chart_type](
                chart_size_factor=_chart_size_factor,
                label_font_size=_chart_label_font_size,
            )
        )
        h_layout.addWidget(
            self._kundali_charts[tab_index + c - _tabcount_before_chart_tab]
        )
        self._chart_info_label1.setText("Chart Information")
        h_layout.addWidget(self._chart_info_label1)
        self._chart_info_label1.setStyleSheet(
            "font-size:" + str(_chart_info_label_font_size) + "pt"
        )
        self._chart_info_label2.setText("Chart Information")
        h_layout.addWidget(self._chart_info_label2)
        self._chart_info_label2.setStyleSheet(
            "font-size:" + str(_chart_info_label_font_size) + "pt"
        )
        h_layout.setSpacing(_margin_between_chart_and_info)
        h_layout.setContentsMargins(0, 0, 0, 0)
        ...
        self._kundali_mixed_chart_index_1 = _mixed_chart_index_1
        self._kundali_mixed_chart_index_2 = _mixed_chart_index_2
        self._kundali_mixed_method_index_1 = _mixed_chart_method_1
        self._kundali_mixed_method_index_2 = _mixed_chart_method_2
    ...
    def _show_kundali_chart_options(self):
        ...
        if self._current_kundali_chart_index < _custom_chart_index:
            varga_index = const.division_chart_factors[
                self._current_kundali_chart_index
            ]
            self._kundali_method_index = self._kundali_varga_dict[varga_index][1]
            self._kundali_chart_options_str = self.resources[
                "d"
                + str(varga_index)
                + "_option"
                + str(self._kundali_method_index)
                + "_str"
            ]
            ...
            self._kundali_method_index = self._kundali_varga_dict[varga_index][1]
            self._kundali_chart_options_str = self.resources[
                "dn_custom_option" + str(self._kundali_method_index) + "_str"
            ]
            ...
            v1s = self.resources[
                ...
                + str(v1)
                + "_option"
                + str(self._kundali_mixed_method_index_1)
                + "_str"
            ]
            v2s = self.resources[
                "d"
                + str(v2)
                + "_option"
                + str(self._kundali_mixed_method_index_2)
                + "_str"
            ]
        ...
        if self._current_kundali_chart_index <= _custom_chart_index:
            dlg = varga_chart_dialog.VargaChartOptionsDialog(
                ...
                count_from_end_of_sign=self._kundali_varga_dict[
                    self._kundali_custom_varga
                ][3],
            )
            if dlg.exec() == 1:
                ...
                if dlg._varga_factor != None:
                    varga_index = dlg._varga_factor
                if self._current_kundali_chart_index == _custom_chart_index:
                    self._kundali_custom_varga = varga_index
                self._kundali_varga_dict[varga_index] = (
                    self._kundali_varga_dict[varga_index][0],
                    dlg._method_index,
                    dlg._base_rasi_index,
                    dlg._count_from_end_of_sign,
                )
            ...
            self._kundali_option_info_label.setText(self._kundali_chart_options_str)
            self._kundali_chart_option_button.setText(
                self._kundali_chart_combo.currentText()
                + " "
                + self.resources["options_str"]
            )
            if self._current_kundali_chart_index == _custom_chart_index:
            ...
            self._kundali_option_info_label.setText(self._kundali_chart_options_str)
            dlg = mixed_chart_dialog.MixedChartOptionsDialog(
                chart_index_1=self._kundali_mixed_chart_index_1,
                chart_index_2=self._kundali_mixed_chart_index_2,
                chart_method_1=self._kundali_mixed_method_index_1,
                chart_method_2=self._kundali_mixed_method_index_2,
            )
            if dlg.exec() == 1:
                self._kundali_mixed_chart_index_1 = dlg._chart_index_1
                self._kundali_mixed_chart_index_2 = dlg._chart_index_2
                self._kundali_mixed_method_index_1 = dlg._method_index_1
                self._kundali_mixed_method_index_2 = dlg._method_index_2
                v1 = dlg._varga_factor_1
                v2 = dlg._varga_factor_2
                v1s = self.resources[
                    "d"
    ...
    def _kundali_chart_selection_changed(self):
        ...
        if self._current_kundali_chart_index == 0:
            self._kundali_chart_option_button.setEnabled(False)
            self._kundali_chart_option_button.setVisible(False)
            self._kundali_option_info_label.setEnabled(False)
            self._kundali_option_info_label.setVisible(False)
        else:
            self._kundali_chart_option_button.setEnabled(True)
            self._kundali_chart_option_button.setVisible(True)
            self._kundali_option_info_label.setEnabled(True)
            self._kundali_option_info_label.setVisible(True)
    ...
    def _init_saham_tab_widgets(self, tab_index):
        ...
        self.horo_tabs.append(QWidget())
        self.tabWidget.addTab(self.horo_tabs[tab_index], "")
        self._saham_table1 = QTableWidget(18, 2)
        self._saham_table1.verticalHeader().setVisible(False)
        self._saham_table2 = QTableWidget(18, 2)
        self._saham_table2.verticalHeader().setVisible(False)
        h_layout1 = QHBoxLayout()
        ...
        self._saham_chart_combo.currentIndexChanged.connect(
        ...
        self._saham_option_info_label.setStyleSheet(
            "border: 2px solid black;font-size:12px; font-weight:bold;"
        )
        self._saham_option_info_label.setEnabled(False)
        self._saham_option_info_label.setSizePolicy(
            QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed
        )
        ...
        self._saham_table1.setStyleSheet(
            "font-size:" + str(_saham_table_font_size) + "pt"
        )
        self._saham_table2.setStyleSheet(
            "font-size:" + str(_saham_table_font_size) + "pt"
        )
        ...
        self._saham_mixed_chart_index_1 = _mixed_chart_index_1
        self._saham_mixed_chart_index_2 = _mixed_chart_index_2
        self._saham_mixed_method_index_1 = _mixed_chart_method_1
        self._saham_mixed_method_index_2 = _mixed_chart_method_2
    ...
    def _show_saham_chart_options(self):
        ...
        if self._current_saham_chart_index < _custom_chart_index:
            ...
            self._saham_chart_options_str = self.resources[
                "d"
                + str(varga_index)
                + "_option"
                + str(self._saham_method_index)
                + "_str"
            ]
            ...
            self._saham_method_index = self._saham_varga_dict[varga_index][1]
            self._saham_chart_options_str = self.resources[
                "dn_custom_option" + str(self._saham_method_index) + "_str"
            ]
            ...
            v1s = self.resources[
                ...
                + str(v1)
                + "_option"
                + str(self._saham_mixed_method_index_1)
                + "_str"
            ]
            v2s = self.resources[
                "d"
                + str(v2)
                + "_option"
                + str(self._saham_mixed_method_index_2)
                + "_str"
            ]
        ...
        if self._current_saham_chart_index <= _custom_chart_index:
            dlg = varga_chart_dialog.VargaChartOptionsDialog(
                chart_index=self._current_saham_chart_index,
                chart_method=self._saham_method_index,
                varga_factor=varga_index,
            ...
            if dlg.exec() == 1:
                ...
                if dlg._varga_factor != None:
                    varga_index = dlg._varga_factor
                if self._current_saham_chart_index == _custom_chart_index:
                    self._saham_custom_varga = varga_index
                self._saham_varga_dict[varga_index] = (
                    self._saham_varga_dict[varga_index][0],
                    dlg._method_index,
                    dlg._base_rasi_index,
                    dlg._count_from_end_of_sign,
                )
            ...
            self._saham_option_info_label.setText(self._saham_chart_options_str)
            dlg = mixed_chart_dialog.MixedChartOptionsDialog(
                chart_index_1=self._saham_mixed_chart_index_1,
                chart_index_2=self._saham_mixed_chart_index_2,
                chart_method_1=self._saham_mixed_method_index_1,
                chart_method_2=self._saham_mixed_method_index_2,
            )
            if dlg.exec() == 1:
                self._saham_mixed_chart_index_1 = dlg._chart_index_1
                self._saham_mixed_chart_index_2 = dlg._chart_index_2
                self._saham_mixed_method_index_1 = dlg._method_index_1
                self._saham_mixed_method_index_2 = dlg._method_index_2
                v1 = dlg._varga_factor_1
                v2 = dlg._varga_factor_2
                v1s = self.resources[
                    "d"
                ...
                self._saham_option_info_label.setText(self._saham_chart_options_str)
                mds = "D" + str(v1) + "xD" + str(v2) + " "
                self._saham_chart_option_button.setText(
                    mds + self.resources["options_str"]
                )
                self._update_saham_table_information(
                    chart_index=self._current_saham_chart_index,
    ...
    def _saham_chart_selection_changed(self):
        ...
        if self._current_saham_chart_index == 0:
            self._saham_chart_option_button.setEnabled(False)
            self._saham_chart_option_button.setVisible(False)
            self._saham_option_info_label.setEnabled(False)
            self._saham_option_info_label.setVisible(False)
        else:
            self._saham_chart_option_button.setEnabled(True)
            self._saham_chart_option_button.setVisible(True)
            self._saham_option_info_label.setEnabled(True)
            self._saham_option_info_label.setVisible(True)
        if self._current_saham_chart_index == _mixed_chart_index:
            ...
            self._saham_chart_option_button.setText(
                self._saham_chart_combo.currentText()
                + " "
                + self.resources["options_str"]
            )
            if self._current_saham_chart_index == _custom_chart_index:
    ...
    def _init_drishti_tab_widgets(self, tab_index):
        ...
        self._drishti_chart_combo.currentIndexChanged.connect(
        ...
        self._drishti_chart_option_button.clicked.connect(
            self._show_drishti_chart_options
        )
        ...
        self._drishti_option_info_label.setStyleSheet(
            "border: 2px solid black;font-size:12px; font-weight:bold;"
        )
        self._drishti_option_info_label.setEnabled(False)
        self._drishti_option_info_label.setSizePolicy(
            QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed
        )
        ...
        self._drishti_table2.setStyleSheet(
            "font-size:" + str(_drishti_table_font_size) + "pt"
        )
        ...
        self._drishti_mixed_chart_index_1 = _mixed_chart_index_1
        self._drishti_mixed_chart_index_2 = _mixed_chart_index_2
        self._drishti_mixed_method_index_1 = _mixed_chart_method_1
        self._drishti_mixed_method_index_2 = _mixed_chart_method_2
    ...
    def _show_drishti_chart_options(self):
        ...
        if self._current_drishti_chart_index < _custom_chart_index:
            ...
            self._drishti_chart_options_str = self.resources[
                "d"
                + str(varga_index)
                + "_option"
                + str(self._drishti_method_index)
                + "_str"
            ]
            ...
            self._drishti_method_index = self._drishti_varga_dict[varga_index][1]
            self._drishti_chart_options_str = self.resources[
                "dn_custom_option" + str(self._drishti_method_index) + "_str"
            ]
            ...
            v1s = self.resources[
                ...
                + str(v1)
                + "_option"
                + str(self._drishti_mixed_method_index_1)
                + "_str"
            ]
            v2s = self.resources[
                "d"
                + str(v2)
                + "_option"
                + str(self._drishti_mixed_method_index_2)
                + "_str"
            ]
        ...
        if self._current_drishti_chart_index <= _custom_chart_index:
            dlg = varga_chart_dialog.VargaChartOptionsDialog(
                chart_index=self._current_drishti_chart_index,
                chart_method=self._drishti_method_index,
                varga_factor=varga_index,
            ...
            if dlg.exec() == 1:
                ...
                if dlg._varga_factor != None:
                    varga_index = dlg._varga_factor
                if self._current_drishti_chart_index == _custom_chart_index:
                    self._drishti_custom_varga = varga_index
                self._drishti_varga_dict[varga_index] = (
                    self._drishti_varga_dict[varga_index][0],
                    dlg._method_index,
                    dlg._base_rasi_index,
                    dlg._count_from_end_of_sign,
                )
            ...
            self._drishti_option_info_label.setText(self._drishti_chart_options_str)
            dlg = mixed_chart_dialog.MixedChartOptionsDialog(
                chart_index_1=self._drishti_mixed_chart_index_1,
                chart_index_2=self._drishti_mixed_chart_index_2,
                chart_method_1=self._drishti_mixed_method_index_1,
                chart_method_2=self._drishti_mixed_method_index_2,
            )
            if dlg.exec() == 1:
                self._drishti_mixed_chart_index_1 = dlg._chart_index_1
                self._drishti_mixed_chart_index_2 = dlg._chart_index_2
                self._drishti_mixed_method_index_1 = dlg._method_index_1
                self._drishti_mixed_method_index_2 = dlg._method_index_2
                v1 = dlg._varga_factor_1
                v2 = dlg._varga_factor_2
                v1s = self.resources[
                    "d"
                ...
                self._drishti_option_info_label.setText(self._drishti_chart_options_str)
                mds = "D" + str(v1) + "xD" + str(v2) + " "
                self._drishti_chart_option_button.setText(
                    mds + self.resources["options_str"]
                )
                self._update_drishti_table_information(
                    chart_index=self._current_drishti_chart_index,
    ...
    def _drishti_chart_selection_changed(self):
        ...
        if self._current_drishti_chart_index == 0:
            self._drishti_chart_option_button.setEnabled(False)
            self._drishti_chart_option_button.setVisible(False)
            self._drishti_option_info_label.setEnabled(False)
            self._drishti_option_info_label.setVisible(False)
        else:
            self._drishti_chart_option_button.setEnabled(True)
            self._drishti_chart_option_button.setVisible(True)
            self._drishti_option_info_label.setEnabled(True)
            self._drishti_option_info_label.setVisible(True)
        if self._current_drishti_chart_index == _mixed_chart_index:
            ...
            self._drishti_chart_option_button.setText(
                self._drishti_chart_combo.currentText()
                + " "
                + self.resources["options_str"]
            )
            if self._current_drishti_chart_index == _custom_chart_index:
    ...
    def _init_shad_bala_tab_widgets(self, tab_index):
        for t in range(_shad_bala_tab_count):
            ...
            self.tabWidget.addTab(self.horo_tabs[tab_index + t], "")
        self._shad_bala_table = [
            QTableWidget(9, 7) for _ in range(_shad_bala_tab_count)
        ]
        for t in range(_shad_bala_tab_count):
            h_layout = QHBoxLayout()
            ...
            for table in [self._shad_bala_table[t]]:
                table.setStyleSheet(
                    "font-size:" + str(_shad_bala_table_font_size) + "pt"
                )
                table.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
                table.setSizeAdjustPolicy(
                    QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents
    ...
    def _init_bhava_bala_tab_widgets(self, tab_index):
        for t in range(_bhava_bala_tab_count):
            ...
            self.tabWidget.addTab(self.horo_tabs[tab_index + t], "")
        self._bhava_bala_table = [
            QTableWidget(12, 3) for _ in range(_bhava_bala_tab_count)
        ]
        for t in range(_bhava_bala_tab_count):
            h_layout = QHBoxLayout()
            ...
            for table in [self._bhava_bala_table[t]]:
                table.setStyleSheet(
                    "font-size:" + str(_bhava_bala_table_font_size) + "pt"
                )
                table.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
                table.setSizeAdjustPolicy(
                    QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents
    ...
    def _init_argala_tab_widgets(self, tab_index):
        ...
        self._argala_chart_combo.currentIndexChanged.connect(
        ...
        self._argala_chart_option_button.clicked.connect(
            self._show_argala_chart_options
        )
        ...
        self._argala_option_info_label.setStyleSheet(
            "border: 2px solid black;font-size:12px; font-weight:bold;"
        )
        self._argala_option_info_label.setEnabled(False)
        self._argala_option_info_label.setSizePolicy(
            QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed
        )
        ...
        self._argala_mixed_chart_index_1 = _mixed_chart_index_1
        self._argala_mixed_chart_index_2 = _mixed_chart_index_2
        self._argala_mixed_method_index_1 = _mixed_chart_method_1
        self._argala_mixed_method_index_2 = _mixed_chart_method_2
    ...
    def _show_argala_chart_options(self):
        ...
        if self._current_argala_chart_index < _custom_chart_index:
            ...
            self._argala_chart_options_str = self.resources[
                "d"
                + str(varga_index)
                + "_option"
                + str(self._argala_method_index)
                + "_str"
            ]
            ...
            self._argala_method_index = self._argala_varga_dict[varga_index][1]
            self._argala_chart_options_str = self.resources[
                "dn_custom_option" + str(self._argala_method_index) + "_str"
            ]
            ...
            v1s = self.resources[
                ...
                + str(v1)
                + "_option"
                + str(self._argala_mixed_method_index_1)
                + "_str"
            ]
            v2s = self.resources[
                "d"
                + str(v2)
                + "_option"
                + str(self._argala_mixed_method_index_2)
                + "_str"
            ]
        ...
        if self._current_argala_chart_index <= _custom_chart_index:
            dlg = varga_chart_dialog.VargaChartOptionsDialog(
                chart_index=self._current_argala_chart_index,
                chart_method=self._argala_method_index,
                varga_factor=varga_index,
            ...
            if dlg.exec() == 1:
                ...
                if dlg._varga_factor != None:
                    varga_index = dlg._varga_factor
                if self._current_argala_chart_index == _custom_chart_index:
                    self._argala_custom_varga = varga_index
                self._argala_varga_dict[varga_index] = (
                    self._argala_varga_dict[varga_index][0],
                    dlg._method_index,
                    dlg._base_rasi_index,
                    dlg._count_from_end_of_sign,
                )
            ...
            self._argala_option_info_label.setText(self._argala_chart_options_str)
            dlg = mixed_chart_dialog.MixedChartOptionsDialog(
                chart_index_1=self._argala_mixed_chart_index_1,
                chart_index_2=self._argala_mixed_chart_index_2,
                chart_method_1=self._argala_mixed_method_index_1,
                chart_method_2=self._argala_mixed_method_index_2,
            )
            if dlg.exec() == 1:
                self._argala_mixed_chart_index_1 = dlg._chart_index_1
                self._argala_mixed_chart_index_2 = dlg._chart_index_2
                self._argala_mixed_method_index_1 = dlg._method_index_1
                self._argala_mixed_method_index_2 = dlg._method_index_2
                v1 = dlg._varga_factor_1
                v2 = dlg._varga_factor_2
                v1s = self.resources[
                    "d"
                ...
                self._argala_option_info_label.setText(self._argala_chart_options_str)
                mds = "D" + str(v1) + "xD" + str(v2) + " "
                self._argala_chart_option_button.setText(
                    mds + self.resources["options_str"]
                )
                self._update_argala_table_information(
                    chart_index=self._current_argala_chart_index,
    ...
    def _argala_chart_selection_changed(self):
        ...
        if self._current_argala_chart_index == 0:
            self._argala_chart_option_button.setEnabled(False)
            self._argala_chart_option_button.setVisible(False)
            self._argala_option_info_label.setEnabled(False)
            self._argala_option_info_label.setVisible(False)
        else:
            self._argala_chart_option_button.setEnabled(True)
            self._argala_chart_option_button.setVisible(True)
            self._argala_option_info_label.setEnabled(True)
            self._argala_option_info_label.setVisible(True)
        if self._current_argala_chart_index == _mixed_chart_index:
            ...
            self._argala_chart_option_button.setText(
                self._argala_chart_combo.currentText()
                + " "
                + self.resources["options_str"]
            )
            if self._current_argala_chart_index == _custom_chart_index:
    ...
    def _init_shodhaya_tab_widgets(self, tab_index):
        ...
        self._shodhaya_chart_combo.currentIndexChanged.connect(
        ...
        self._shodhaya_chart_option_button.clicked.connect(
            self._show_shodhaya_chart_options
        )
        ...
        self._shodhaya_option_info_label.setStyleSheet(
            "border: 2px solid black;font-size:12px; font-weight:bold;"
        )
        self._shodhaya_option_info_label.setEnabled(False)
        self._shodhaya_option_info_label.setSizePolicy(
            QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed
        )
        ...
        self._shodhaya_mixed_chart_index_1 = _mixed_chart_index_1
        self._shodhaya_mixed_chart_index_2 = _mixed_chart_index_2
        self._shodhaya_mixed_method_index_1 = _mixed_chart_method_1
        self._shodhaya_mixed_method_index_2 = _mixed_chart_method_2
    ...
    def _show_shodhaya_chart_options(self):
        ...
        if self._current_shodhaya_chart_index < _custom_chart_index:
            ...
            self._shodhaya_chart_options_str = self.resources[
                "d"
                + str(varga_index)
                + "_option"
                + str(self._shodhaya_method_index)
                + "_str"
            ]
            ...
            self._shodhaya_method_index = self._shodhaya_varga_dict[varga_index][1]
            self._shodhaya_chart_options_str = self.resources[
                "dn_custom_option" + str(self._shodhaya_method_index) + "_str"
            ]
            ...
            v1s = self.resources[
                ...
                + str(v1)
                + "_option"
                + str(self._shodhaya_mixed_method_index_1)
                + "_str"
            ]
            v2s = self.resources[
                "d"
                + str(v2)
                + "_option"
                + str(self._shodhaya_mixed_method_index_2)
                + "_str"
            ]
        ...
        if self._current_shodhaya_chart_index <= _custom_chart_index:
            dlg = varga_chart_dialog.VargaChartOptionsDialog(
                chart_index=self._current_shodhaya_chart_index,
                chart_method=self._shodhaya_method_index,
                varga_factor=varga_index,
            ...
            if dlg.exec() == 1:
                ...
                if dlg._varga_factor != None:
                    varga_index = dlg._varga_factor
                if self._current_shodhaya_chart_index == _custom_chart_index:
                    self._shodhaya_custom_varga = varga_index
                self._shodhaya_varga_dict[varga_index] = (
                    self._shodhaya_varga_dict[varga_index][0],
                    dlg._method_index,
                    dlg._base_rasi_index,
                    dlg._count_from_end_of_sign,
                )
            ...
            self._shodhaya_option_info_label.setText(self._shodhaya_chart_options_str)
            dlg = mixed_chart_dialog.MixedChartOptionsDialog(
                chart_index_1=self._shodhaya_mixed_chart_index_1,
                chart_index_2=self._shodhaya_mixed_chart_index_2,
                chart_method_1=self._shodhaya_mixed_method_index_1,
                chart_method_2=self._shodhaya_mixed_method_index_2,
            )
            if dlg.exec() == 1:
                self._shodhaya_mixed_chart_index_1 = dlg._chart_index_1
                self._shodhaya_mixed_chart_index_2 = dlg._chart_index_2
                self._shodhaya_mixed_method_index_1 = dlg._method_index_1
                self._shodhaya_mixed_method_index_2 = dlg._method_index_2
                v1 = dlg._varga_factor_1
                v2 = dlg._varga_factor_2
                v1s = self.resources[
                    "d"
                ...
                self._shodhaya_option_info_label.setText(
                    self._shodhaya_chart_options_str
                )
                mds = "D" + str(v1) + "xD" + str(v2) + " "
                self._shodhaya_chart_option_button.setText(
                    mds + self.resources["options_str"]
                )
                self._update_shodhaya_table_information(
                    chart_index=self._current_shodhaya_chart_index,
    ...
    def _shodhaya_chart_selection_changed(self):
        ...
        if self._current_shodhaya_chart_index == 0:
            self._shodhaya_chart_option_button.setEnabled(False)
            self._shodhaya_chart_option_button.setVisible(False)
            self._shodhaya_option_info_label.setEnabled(False)
            self._shodhaya_option_info_label.setVisible(False)
        else:
            self._shodhaya_chart_option_button.setEnabled(True)
            self._shodhaya_chart_option_button.setVisible(True)
            self._shodhaya_option_info_label.setEnabled(True)
            self._shodhaya_option_info_label.setVisible(True)
        if self._current_shodhaya_chart_index == _mixed_chart_index:
            ...
            self._shodhaya_chart_option_button.setText(
                self._shodhaya_chart_combo.currentText()
                + " "
                + self.resources["options_str"]
            )
            if self._current_shodhaya_chart_index == _custom_chart_index:
    ...
    def _init_ashtaka_tab_widgets(self, tab_index):
        ...
        self._ashtaka_chart_combo.currentIndexChanged.connect(
        ...
        self._ashtaka_chart_option_button.clicked.connect(
            self._show_ashtaka_chart_options
        )
        ...
        self._ashtaka_option_info_label.setStyleSheet(
            "border: 2px solid black;font-size:12px; font-weight:bold;"
        )
        self._ashtaka_option_info_label.setEnabled(False)
        self._ashtaka_option_info_label.setSizePolicy(
            QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed
        )
        ...
        self._ashtaka_charts = [
            (__chart_type(chart_size_factor=_ashtaka_chart_size_factor))
            for i in range(9)
        ]
        ac = 0
        for i in range(3):
        ...
        self._ashtaka_mixed_chart_index_1 = _mixed_chart_index_1
        self._ashtaka_mixed_chart_index_2 = _mixed_chart_index_2
        self._ashtaka_mixed_method_index_1 = _mixed_chart_method_1
        self._ashtaka_mixed_method_index_2 = _mixed_chart_method_2
    ...
    def _show_ashtaka_chart_options(self):
        ...
        if self._current_ashtaka_chart_index < _custom_chart_index:
            ...
            self._ashtaka_chart_options_str = self.resources[
                "d"
                + str(varga_index)
                + "_option"
                + str(self._ashtaka_method_index)
                + "_str"
            ]
            ...
            self._ashtaka_method_index = self._ashtaka_varga_dict[varga_index][1]
            self._ashtaka_chart_options_str = self.resources[
                "dn_custom_option" + str(self._ashtaka_method_index) + "_str"
            ]
            ...
            v1s = self.resources[
                ...
                + str(v1)
                + "_option"
                + str(self._ashtaka_mixed_method_index_1)
                + "_str"
            ]
            v2s = self.resources[
                "d"
                + str(v2)
                + "_option"
                + str(self._ashtaka_mixed_method_index_2)
                + "_str"
            ]
        ...
        if self._current_ashtaka_chart_index <= _custom_chart_index:
            dlg = varga_chart_dialog.VargaChartOptionsDialog(
                chart_index=self._current_ashtaka_chart_index,
                chart_method=self._ashtaka_method_index,
                varga_factor=varga_index,
            ...
            if dlg.exec() == 1:
                ...
                if dlg._varga_factor != None:
                    varga_index = dlg._varga_factor
                if self._current_ashtaka_chart_index == _custom_chart_index:
                    self._ashtaka_custom_varga = varga_index
                self._ashtaka_varga_dict[varga_index] = (
                    self._ashtaka_varga_dict[varga_index][0],
                    dlg._method_index,
                    dlg._base_rasi_index,
                    dlg._count_from_end_of_sign,
                )
            ...
            self._ashtaka_option_info_label.setText(self._ashtaka_chart_options_str)
            dlg = mixed_chart_dialog.MixedChartOptionsDialog(
                chart_index_1=self._ashtaka_mixed_chart_index_1,
                chart_index_2=self._ashtaka_mixed_chart_index_2,
                chart_method_1=self._ashtaka_mixed_method_index_1,
                chart_method_2=self._ashtaka_mixed_method_index_2,
            )
            if dlg.exec() == 1:
                self._ashtaka_mixed_chart_index_1 = dlg._chart_index_1
                self._ashtaka_mixed_chart_index_2 = dlg._chart_index_2
                self._ashtaka_mixed_method_index_1 = dlg._method_index_1
                self._ashtaka_mixed_method_index_2 = dlg._method_index_2
                v1 = dlg._varga_factor_1
                v2 = dlg._varga_factor_2
                v1s = self.resources[
                    "d"
                ...
                self._ashtaka_option_info_label.setText(self._ashtaka_chart_options_str)
                mds = "D" + str(v1) + "xD" + str(v2) + " "
                self._ashtaka_chart_option_button.setText(
                    mds + self.resources["options_str"]
                )
                self._update_ashtaka_varga_tab_information(
                    chart_index=self._current_kundali_chart_index,
    ...
    def _ashtaka_chart_selection_changed(self):
        ...
        if self._current_ashtaka_chart_index == 0:
            self._ashtaka_chart_option_button.setEnabled(False)
            self._ashtaka_chart_option_button.setVisible(False)
            self._ashtaka_option_info_label.setEnabled(False)
            self._ashtaka_option_info_label.setVisible(False)
        else:
            self._ashtaka_chart_option_button.setEnabled(True)
            self._ashtaka_chart_option_button.setVisible(True)
            self._ashtaka_option_info_label.setEnabled(True)
            self._ashtaka_option_info_label.setVisible(True)
        if self._current_ashtaka_chart_index == _mixed_chart_index:
            ...
            self._ashtaka_chart_option_button.setText(
                self._ashtaka_chart_combo.currentText()
                + " "
                + self.resources["options_str"]
            )
            if self._current_ashtaka_chart_index == _custom_chart_index:
    ...
    def _init_main_window(self):
        ...
        self._language = list(available_languages.keys())[
            0
        ]  # list(available_languages.keys())[0]
        ci = _index_containing_substring(
            available_chart_types.keys(), self._chart_type.lower()
        )
        if ci >= 0:
    ...
    def _create_row1_ui(self):
        ...
        if self.use_internet_for_location_check:
            self._place_text.editingFinished.connect(
                lambda: self._get_location(self._place_text.text())
            )
        ...
        self._latitude = 0.0
        self._lat_text.setToolTip(
            "Enter Latitude preferably exact at place of birth: Format: +/- xx.xxx"
        )
        ...
        self._longitude = 0.0
        self._long_text.setToolTip(
            "Enter Longitude preferably exact at place of birth. Format +/- xx.xxx"
        )
    ...
    def _create_row_3_ui(self):
        ...
        self._pravesha_combo.setToolTip(
            "Choose type of Pravesha (Janma, annual, tithi, present)"
        )
        ...
        self._compute_button.clicked.connect(
            lambda: self.compute_horoscope(calculation_type=self._calculation_type)
        )
        self._compute_button.setToolTip(
            "Click to update the chart information based on selections made"
        )
        ...
        self._save_image_button.clicked.connect(
            lambda: self.save_as_pdf(pdf_file_name=None)
        )
        ...
        self._save_city_button.setToolTip(
            "Click to save the city information in csv database"
        )
    ...
    def _create_row_2_and_3_ui(self):
        ...
        self._tob_text.setToolTip(
            "Enter time of birth in the format HH:MM:SS if afternoon use 12+ hours"
        )
        ...
        self._chart_type_combo.setToolTip(
            "Choose birth chart style north, south or east indian"
        )
    ...
    def _create_comp_ui(self):
        ...
        self._sthree_dheerga_porutham = (
            self._sthree_dheerga_porutham_checkbox.isChecked()
        )
    ...
    def _show_dhasa_options(self):
        ...
        if tab_str not in [self.resources["karaka_str"], self.resources["kaala_str"]]:
            dlg = dhasa_bhukthi_options_dialog.DhasaBhukthiOptionDialog(
                self._current_dhasa_index,
                self._dhasa_options_list[self._current_dhasa_index],
            )
            if dlg.exec() == 1:
                self._dhasa_bhukthi_options_str[
                    self._current_dhasa_index
                ] = dlg._option_string
    ...
    def _show_vratha_finder_dialog(self):
        ...
        place = drik.Place(
            self._place_text.text(),
            float(self._lat_text.text()),
            float(self._long_text.text()),
        ...
        if dlg.exec() == 1:
            ...
            self._time_of_birth = ":".join(
                [str(x) for x in utils.to_dms(fh, as_string=False)]
            )
        else:
    ...
    def _show_conjunction_dialog(self, entry_type=0, chart_title=""):
        ...
        jd_at_dob = utils.julian_day_number(dob, tob)
        dlg = conjunction_dialog.ConjunctionDialog(
            jd_at_dob,
            place,
            entry_type=entry_type,
            chart_title=utils.resource_strings[chart_title],
        )
        self._conjunction_dialog_accepted = False
        if dlg.exec() == 1:
            self._conjunction_dialog_accepted = dlg._accept_clicked
    ...
    def _enable_disable_annual_ui(self):
        ...
        user_age = (
            min(datetime.now().year - birth_date.year, const.annual_maximum_age) + 1
        )
        dob = (int(year), int(month), int(day))
        tob = tuple([int(x) for x in self._tob_text.text().split(":")])
        self._birth_julian_day = utils.julian_day_number(dob, tob)
        ...
        self._60hrs_combo.setValue(1)
        self._months_combo.setValue(1)
        self._years_combo.setEnabled(False)
        self._months_combo.setEnabled(False)
        self._60hrs_combo.setEnabled(False)
        if self._pravesha_combo.currentIndex() == const._PRAVESHA_LIST.index(
            "birth_str"
        ):
            self._years = 1
            self._60hrs = 1
        ...
        elif self._pravesha_combo.currentIndex() == const._PRAVESHA_LIST.index(
            "annual_str"
        ):
            jd_at_dob = utils.julian_day_number(dob, tob)
            jd_years = drik.next_solar_date(
                jd_at_dob, place, user_age, self._months, self._60hrs
            )
            ...
            tp_date = tp[0][0]
            tp_time = tp[0][1]
            tithi_time = tuple(utils.to_dms(tp_time, as_string=False))
            ...
            self._date_of_birth = today.strftime("%Y,%m,%d")
            self._time_of_birth = today.strftime("%H:%M:%S")
        elif (
            self._pravesha_combo.currentIndex()
            == const._PRAVESHA_LIST.index("planetary_conjunctions_str")
            or self._pravesha_combo.currentIndex()
            == const._PRAVESHA_LIST.index("planet_transit_str")
            or self._pravesha_combo.currentIndex()
            == const._PRAVESHA_LIST.index("vakra_gathi_change_str")
            or self._pravesha_combo.currentIndex()
            == const._PRAVESHA_LIST.index("lunar_month_year_str")
        ):
            pass
        elif self._pravesha_combo.currentIndex() == const._PRAVESHA_LIST.index(
            "prenatal_time_str"
            ...
            jd_at_dob = utils.julian_day_number(dob, tob)
            jd_years = drik.next_solar_date(
                jd_at_dob, place, self._years, self._months, self._60hrs
            )
            y, m, d, fh = utils.jd_to_gregorian(jd_years)
            self._date_of_birth = str(y) + "," + str(m) + "," + str(d)
            self._time_of_birth = ":".join(
            ...
            self._months_combo.setEnabled(True)
            self._60hrs_combo.setEnabled(True)
        else:
    ...
    def _show_lunar_month_dialog(self):
        ...
        _title_list = ["amantha", "purnimantha", "solar"]
        _lmd_count = 3
        _title = (
            "/".join([self.resources[ol + "_str"] for ol in _title_list])
            + " "
            + self.resources["month_str"]
            + "/"
            + self.resources["year_str"]
        )
        option_list = [
            [
                self.resources[ol + "_str"] + " " + self.resources["month_str"]
                for ol in _title_list
            ]
            + [
                self.resources[ol + "_str"] + " " + self.resources["year_str"]
                for ol in _title_list
            ],
        ...
        lm_dlg = OptionDialog(
            title=_title,
            option_label=self.resources["select_one_of_options_from_str"],
        ...
        self._lunar_month_type = ""
        if lm_dlg.exec() == 1:
            _lunar_month_type, _direction = lm_dlg._option_index
            _lunar_month_type -= 1
            if _direction == 1:
                ...
                if _lunar_month_type < _lmd_count:
                    (
                        ...
                        _lm_month,
                        _lm_day,
                    ), _lm_hours = drik.previous_lunar_month(
                        jd, place, _lunar_month_type
                    )
                else:
                    (
                        _lm_year,
                        _lm_month,
                        _lm_day,
                    ), _lm_hours = drik.previous_lunar_year(
                        jd, place, _lunar_month_type - _lmd_count
                    )
            else:
                direction_string = self.resources["next_str"] + " "
                if _lunar_month_type < _lmd_count:
                    (_lm_year, _lm_month, _lm_day), _lm_hours = drik.next_lunar_month(
                        jd, place, _lunar_month_type
                    )
                else:
                    (_lm_year, _lm_month, _lm_day), _lm_hours = drik.next_lunar_year(
                        jd, place, _lunar_month_type - _lmd_count
                    )
            self._date_of_birth = (
                str(_lm_year) + "," + str(_lm_month) + "," + str(_lm_day)
            )
            self._time_of_birth = ":".join(
                [str(x) for x in utils.to_dms(_lm_hours, as_string=False)]
            )
            if _lunar_month_type < 2:  # < 3
                self._lunar_month_type = (
                    direction_string
                    + " "
                    + self.resources[_title_list[_lunar_month_type] + "_str"]
                    + " "
                    + self.resources["month_str"]
                )
            else:
                self._lunar_month_type = (
                    ...
                    + " "
                    + self.resources[
                        _title_list[_lunar_month_type - _lmd_count] + "_str"
                    ]
                    + " "
                    + self.resources["year_str"]
                )
    ...
    def chart_type(self, chart_type):
        ...
        """
        ci = _index_containing_substring(
            available_chart_types.keys(), chart_type.lower()
        )
        if ci >= 0:
            self._chart_type = list(available_chart_types.keys())[ci]
    ...
    def minimum_compatibility_score(self, minm_comp_score: float = 18.0):
        ...
        if "south" in self._chart_type.lower():
            if (
                ...
                and minm_comp_score > 0
                and minm_comp_score <= const.compatibility_maximum_score_south
            ):
            ...
            if (
                self._show_compatibility
                and minm_comp_score > 0.0
                and minm_comp_score <= const.compatibility_maximum_score_north
            ):
                self._minimum_score = minm_comp_score
                self._min_score_combo.setValue(minm_comp_score)
    ...
    def _validate_ui(self):
        all_data_ok = (
            ...
            and re.match(
                r"[\+|\-]?\d+\.\d+\s?", self._lat_text.text().strip(), re.IGNORECASE
            )
            and re.match(
                r"[\+|\-]?\d+\.\d+\s?", self._long_text.text().strip(), re.IGNORECASE
            )
            and re.match(
                r"[\+|\-]?\d{1,5}\,\d{1,2}\,\d{1,2}",
                self._dob_text.text().strip(),
                re.IGNORECASE,
            )
            and re.match(
                r"\d{1,2}:\d{1,2}:\d{1,2}", self._tob_text.text().strip(), re.IGNORECASE
            )
        )
        return all_data_ok
        ...
        try:
            if self.resources:
                ...
                self._name_label.setStyleSheet(
                    "font-size:" + str(_main_ui_label_button_font_size) + "pt"
                )
                ...
                self._long_label.setStyleSheet(
                    "font-size:" + str(_main_ui_label_button_font_size) + "pt"
                )
                ...
                self._years = _years_prev
                self._months = _months_prev
                self._60hrs = _60hrs_prev
                ...
                self._chart_type_combo.addItems(
                    [msgs[c + "_str"] for c in available_chart_types.keys()]
                )
                ...
                _amsa_ruler_list = [
                    msgs[_chart_names[const.division_chart_factors.index(ak)]]
                    for ak in _ar_keys[:-1]
                ...
                self._compute_button.setStyleSheet(
                    "font-size:" + str(_main_ui_label_button_font_size) + "pt"
                )
                self._compute_button.setToolTip(msgs["compute_tooltip_str"])
                self._save_image_button.setText(msgs["save_pdf_str"])
                self._save_image_button.setStyleSheet(
                    "font-size:" + str(_main_ui_label_button_font_size) + "pt"
                )
                self._save_image_button.setToolTip(msgs["savepdf_tooltip_str"])
                self._save_city_button.setText(msgs["save_city_str"])
                self._save_city_button.setStyleSheet(
                    "font-size:" + str(_main_ui_label_button_font_size) + "pt"
                )
                self._save_city_button.setToolTip(msgs["savecity_tooltip_str"])
                self._mahendra_porutham_checkbox.setText(
                    msgs["mahendra_match_str"]
                )  # .split()[0])
                self._mahendra_porutham_checkbox.setStyleSheet(
                    "font-size:" + str(_main_ui_label_button_font_size) + "pt"
                )
                self._mahendra_porutham_checkbox.setToolTip(
                    msgs["mahendra_tooltip_str"]
                )
                self._vedha_porutham_checkbox.setText(
                    msgs["vedha_match_str"]
                )  # .split()[0])
                self._vedha_porutham_checkbox.setStyleSheet(
                    "font-size:" + str(_main_ui_label_button_font_size) + "pt"
                )
                self._vedha_porutham_checkbox.setToolTip(msgs["vedha_tooltip_str"])
                self._rajju_porutham_checkbox.setText(
                    msgs["rajju_match_str"]
                )  # .split()[0])
                self._rajju_porutham_checkbox.setStyleSheet(
                    "font-size:" + str(_main_ui_label_button_font_size) + "pt"
                )
                self._rajju_porutham_checkbox.setToolTip(msgs["rajju_tooltip_str"])
                self._sthree_dheerga_porutham_checkbox.setText(
                    msgs["sthree_dheerga_match_str"]
                )  # .split()[0])
                self._sthree_dheerga_porutham_checkbox.setStyleSheet(
                    "font-size:" + str(_main_ui_label_button_font_size) + "pt"
                )
                self._sthree_dheerga_porutham_checkbox.setToolTip(
                    msgs["sthree_dheerga_tooltip_str"]
                )
                self._min_score_label.setText(msgs["min_score_label_str"])
                self._min_score_label.setStyleSheet(
                    "font-size:" + str(_main_ui_label_button_font_size) + "pt"
                )
            ...
            print(
                "Some error happened during changing to",
                self._language,
                " language and displaying UI in that language.\n"
                + "Please Check resources file:",
                const._DEFAULT_LANGUAGE_MSG_STR
                + available_languages[self._language]
                + ".txt",
            )
            print(sys.exc_info())
    ...
    def _update_combos(self):
        self._current_kundali_chart_index = (
            self._kundali_chart_combo.currentIndex()
            if self._kundali_chart_combo.currentIndex() >= 0
            else 0
        )
        self._kundali_chart_combo.clear()
        self._kundali_chart_combo.addItems(
            [self.resources[cht] for cht in _chart_names]
        )
        self._kundali_chart_combo.SizeAdjustPolicy.AdjustToContents
        ...
        if not self._western_chart:
            self._current_shodhaya_chart_index = (
                self._shodhaya_chart_combo.currentIndex()
                if self._shodhaya_chart_combo.currentIndex() >= 0
                else 0
            )
            self._shodhaya_chart_combo.clear()
            self._shodhaya_chart_combo.addItems(
                [self.resources[cht] for cht in _chart_names]
            )
            self._shodhaya_chart_combo.SizeAdjustPolicy.AdjustToContents
            self._shodhaya_chart_combo.adjustSize()
            self._shodhaya_chart_combo.setCurrentIndex(
                self._current_shodhaya_chart_index
            )
            self._shodhaya_chart_option_button.setText(
                self._shodhaya_chart_combo.currentText()
            ...
            self._current_argala_chart_index = (
                self._argala_chart_combo.currentIndex()
                if self._argala_chart_combo.currentIndex() >= 0
                else 0
            )
            self._argala_chart_combo.clear()
            self._argala_chart_combo.addItems(
                [self.resources[cht] for cht in _chart_names]
            )
            self._argala_chart_combo.SizeAdjustPolicy.AdjustToContents
            ...
            self._current_saham_chart_index = (
                self._saham_chart_combo.currentIndex()
                if self._saham_chart_combo.currentIndex() >= 0
                else 0
            )
            self._saham_chart_combo.clear()
            self._saham_chart_combo.addItems(
                [self.resources[cht] for cht in _chart_names]
            )
            self._saham_chart_combo.SizeAdjustPolicy.AdjustToContents
            ...
            self._current_drishti_chart_index = (
                self._drishti_chart_combo.currentIndex()
                if self._drishti_chart_combo.currentIndex() >= 0
                else 0
            )
            self._drishti_chart_combo.clear()
            self._drishti_chart_combo.addItems(
                [self.resources[cht] for cht in _chart_names]
            )
            self._drishti_chart_combo.SizeAdjustPolicy.AdjustToContents
            ...
            self._current_chakra_chart_index = (
                self._chakra_chart_combo.currentIndex()
                if self._chakra_chart_combo.currentIndex() >= 0
                else 0
            )
            self._chakra_chart_combo.clear()
            self._chakra_chart_combo.addItems(
                [self.resources[cht] for cht in _chart_names]
            )
            self._chakra_chart_combo.SizeAdjustPolicy.AdjustToContents
            ...
            for c in range(len(_available_chakras)):
                self._chakra_options_group.button(c).setText(
                    self.resources[_available_chakras[c] + "_str"]
                )
            self._current_sphuta_chart_index = (
                self._sphuta_chart_combo.currentIndex()
                if self._sphuta_chart_combo.currentIndex() >= 0
                else 0
            )
            self._sphuta_chart_combo.clear()
            self._sphuta_chart_combo.addItems(
                [self.resources[cht] for cht in _chart_names]
            )
            self._sphuta_chart_combo.SizeAdjustPolicy.AdjustToContents
            self._sphuta_chart_combo.adjustSize()
            self._sphuta_chart_combo.setCurrentIndex(self._current_sphuta_chart_index)
            self._current_kpinfo_chart_index = (
                self._kpinfo_chart_combo.currentIndex()
                if self._kpinfo_chart_combo.currentIndex() >= 0
                else 0
            )
            self._kpinfo_chart_combo.clear()
            self._kpinfo_chart_combo.addItems(
                [self.resources[cht] for cht in _chart_names]
            )
            self._kpinfo_chart_combo.SizeAdjustPolicy.AdjustToContents
            ...
            self._arudha_chart_combo.addItems(
                [self.resources[cht] for cht in _chart_names]
            )
            self._arudha_chart_combo.SizeAdjustPolicy.AdjustToContents
            ...
            self._bhava_arudha_combo.addItems(
                [self.resources[r] for r in _bhava_arudha_list]
            )
            self._bhava_arudha_combo.setCurrentIndex(_bhava_arudha_index)
            self._current_ashtaka_chart_index = (
                self._ashtaka_chart_combo.currentIndex()
                if self._ashtaka_chart_combo.currentIndex() >= 0
                else 0
            )
            self._ashtaka_chart_combo.clear()
            self._ashtaka_chart_combo.addItems(
                [self.resources[cht] for cht in _chart_names]
            )
            self._ashtaka_chart_combo.SizeAdjustPolicy.AdjustToContents
            self._ashtaka_chart_combo.adjustSize()
            self._ashtaka_chart_combo.setCurrentIndex(self._current_ashtaka_chart_index)
            self._current_dhasa_type_index = (
                self._dhasa_type_combo.currentIndex()
                if self._dhasa_type_combo.currentIndex() >= 0
                else 0
            )
            self._dhasa_type_combo.clear()
            self._dhasa_type_combo.addItems(
                [
                    d + " " + self.resources["dhasa_str"]
                    for d in [
                        self.resources["graha_str"],
                        self.resources["raasi_str"],
                        self.resources["annual_str"],
                    ]
                ]
            )
            ...
            self._dhasa_type_combo.setCurrentIndex(self._current_dhasa_type_index)
            self._current_dhasa_index = (
                self._dhasa_combo.currentIndex()
                if self._dhasa_combo.currentIndex() >= 0
                else 0
            )
            self._dhasa_combo.clear()
            if self._dhasa_type_combo.currentIndex() == 0:
                self._dhasa_combo.addItems(
                    [self.resources[d + "_str"] for d in _graha_dhasa_dict.keys()]
                )
                self._dhasa_options_button.setVisible(True)
                self._dhasa_varga_combo.setVisible(False)
            elif self._dhasa_type_combo.currentIndex() == 1:
                ...
                self._dhasa_varga_combo.setVisible(True)
                self._dhasa_combo.addItems(
                    [self.resources[d + "_str"] for d in _rasi_dhasa_dict.keys()]
                )
            else:
                self._dhasa_options_button.setVisible(False)
                self._dhasa_varga_combo.setVisible(True)
                self._dhasa_combo.addItems(
                    [self.resources[d + "_str"] for d in _annual_dhasa_dict.keys()]
                )
            self._dhasa_combo.setCurrentIndex(self._current_dhasa_index)
            self._current_dhasa_varga_index = (
                self._dhasa_varga_combo.currentIndex()
                if self._dhasa_varga_combo.currentIndex() >= 0
                else 0
            )
            self._dhasa_varga_combo.clear()
            self._dhasa_varga_combo.addItems(
                [self.resources[cht] for cht in _chart_names]
            )
            self._dhasa_varga_combo.adjustSize()
            self._dhasa_varga_combo.setCurrentIndex(self._current_dhasa_varga_index)
            self._dhasa_options_button.setText(
                self._dhasa_combo.currentText() + " " + self.resources["options_str"]
            )
    ...
    def compute_horoscope(self, calculation_type="drik"):
        ...
        self._language = list(const.available_languages.keys())[
        ...
        if (
            self.use_internet_for_location_check
            and self._place_name.strip() == ""
            and abs(self._latitude) > 0.0
            and abs(self._longitude) > 0.0
            and abs(self._time_zone) > 0.0
        ):
            [
                self._place_name,
                self._latitude,
        ...
        if self._pravesha_combo.currentIndex() == const._PRAVESHA_LIST.index(
            "planetary_conjunctions_str"
        ):
            self._show_conjunction_dialog(
                entry_type=0, chart_title="planetary_conjunctions_str"
            )
        elif self._pravesha_combo.currentIndex() == const._PRAVESHA_LIST.index(
            "planet_transit_str"
        ):
            self._show_conjunction_dialog(
                entry_type=1, chart_title="planet_transit_str"
            )
        elif self._pravesha_combo.currentIndex() == const._PRAVESHA_LIST.index(
            "vakra_gathi_change_str"
        ):
            self._show_conjunction_dialog(
                entry_type=2, chart_title="vakra_gathi_change_str"
            )
        elif self._pravesha_combo.currentIndex() == const._PRAVESHA_LIST.index(
            "lunar_month_year_str"
        ):
            ...
            birth_date = drik.Date(int(year), int(month), int(day))
            if (
                self._place_name.strip() != ""
                and abs(self._latitude) > 0.0
                and abs(self._longitude) > 0.0
                and abs(self._time_zone) > 0.0
            ):
                self._horo = main.Horoscope(
                    ...
                    ayanamsa_value=self._ayanamsa_value,
        ...
        year, month, day = self._date_of_birth.split(",")
        birth_date = drik.Date(int(year), int(month), int(day))
        self._chart_type = list(available_chart_types)[
            self._chart_type_combo.currentIndex()
        ]
        ...
        (
            self._kundali_info,
            self._kundali_chart,
            self._kundali_ascendant_house,
        ) = self._horo.get_horoscope_information_for_chart(
            self._current_kundali_chart_index,
            chart_method=self._kundali_method_index,
            varnada_method=self._varnada_method_index,
            base_rasi=self._kundali_varga_dict[self._kundali_custom_varga][2],
            count_from_end_of_sign=self._kundali_varga_dict[self._kundali_custom_varga][
                3
            ],
        )
        if not self._western_chart:
            ...
            for tab_str, tab_values in _rasi_dhasa_dict.items():
                retval = eval(
                    "self._horo._get_"
                    + tab_str
                    + "_dhasa(dob, tob, place,divisional_chart_factor="
                    + str(dcf)
                    + ")"
                )
                tab_values[7] = retval
            ...
            self._vaiseshikamsa_bala_info = self._horo._get_vaiseshikamsa_bala(
                dob, tob, place
            )
    ...
    def _fill_panchangam_info(self, info_str, format_str):
        ...
        self.panchanga_info_dialog.update_panchangam_info(
            jd, place, ayanamsa_mode=self._ayanamsa_mode
        )
        return

    def _convert_1d_chart_with_planet_names(
        self, chart_1d_list
            ...
            for z, pls in chart_1d:
                ...
                for p in tmp:
                    if p == const._ascendant_symbol:
                        pl_str += (
                            self.resources["ascendant_short_str"] + "/"
                        )  #' 'Lagnam'+'/'#const._ascendant_symbol+"/"
                    else:
                        ret_str = ""
                        if int(p) in retrograde_planets:
                            ret_str = const._retrogade_symbol
                        pl_str += (
                            utils.PLANET_SHORT_NAMES[int(p)] + ret_str + "/"
                        )  # house.planet_list[int(p)]+'/'#const._planet_symbols[int(p)]+'/'
                pl_str = pl_str[:-1]
                res.append((z, pl_str))
            result.append(res)
        return result
    ...
    def _get_tab_chart_prefix(self):
        ...
        if int(self._months_combo.text()) > 1:
            ...
            if self._pravesha_combo.currentIndex() == const._PRAVESHA_LIST.index(
                ...
                pstr1 = (
                    self.resources["ascendant_str"]
                    if self._conj_planet1 == "L"
                    else utils.PLANET_NAMES[self._conj_planet1]
                )
                pstr2 = (
                    self.resources["ascendant_str"]
                    if self._conj_planet2 == "L"
                    else utils.PLANET_NAMES[self._conj_planet2]
                )
                pstr = pstr1 + "/" + pstr2
                ...
                pstr = (
                    utils.PLANET_NAMES[self._conj_planet1]
                    + "-"
                    + self.resources["vakra_gathi_change_str"]
                )
    ...
    def _get_menu_dicts(
        ...
        if chart_index == _mixed_chart_index:
            planet_positions = charts.mixed_chart(
                ...
                place,
                varga_factor_1=v1,
                chart_method_1=chart_method_1,
                varga_factor_2=v2,
                chart_method_2=chart_method_2,
            )
            _varnada_menu_dict = self._horo.get_varnada_lagna_for_mixed_chart(
                dob,
                tob,
                place,
                varga_factor_1=v1,
            ...
            _karaka_menu_dict = self._horo.get_chara_karakas_for_mixed_chart(
                jd,
                place,
                varga_factor_1=v1,
                chart_method_1=chart_method_1,
            ...
            _special_lagna_menu_dict = self._horo.get_special_lagnas_for_mixed_chart(
                jd,
                place,
                varga_factor_1=v1,
                chart_method_1=chart_method_1,
            ...
            _special_planets_menu_dict = self._horo.get_special_planets_for_mixed_chart(
                jd,
                place,
                varga_factor_1=v1,
                chart_method_1=chart_method_1,
            ...
            _sphuta_menu_dict = self._horo.get_sphutas_for_mixed_chart(
                jd,
                place,
                varga_factor_1=v1,
                chart_method_1=chart_method_1,
            ...
            _yogi_info = self._horo.get_ava_saha_yoga_for_mixed_chart(
                jd,
                place,
                varga_factor_1=v1,
                chart_method_1=chart_method_1,
            ...
            _varnada_menu_dict = self._horo.get_varnada_lagna_for_chart(
                dob,
                tob,
                place,
                divisional_chart_factor=dcf,
            ...
            _karaka_menu_dict = self._horo.get_chara_karakas_for_chart(
                jd,
                place,
                divisional_chart_factor=dcf,
                chart_method=chart_method,
            ...
            _special_lagna_menu_dict = self._horo.get_special_lagnas_for_chart(
                jd,
                place,
                divisional_chart_factor=dcf,
                chart_method=chart_method,
            ...
            _special_planets_menu_dict = self._horo.get_special_planets_for_chart(
                jd,
                place,
                divisional_chart_factor=dcf,
                chart_method=chart_method,
            ...
            _sphuta_menu_dict = self._horo.get_sphutas_for_chart(
                jd,
                place,
                divisional_chart_factor=dcf,
                chart_method=chart_method,
            ...
            _yogi_info = self._horo.get_ava_saha_yoga_info_for_chart(
                jd,
                place,
                divisional_chart_factor=dcf,
                chart_method=chart_method,
        ...
        if dcf == 3:
            _ndl_table = [
                ["" for _ in range(3)] for _ in range(len(drik.planet_list) + 2)
            ]
            _colors = [
                ["Green", "Blue", "Brown"] for _ in range(len(drik.planet_list) + 2)
            ]
            ...
            v_layout = QVBoxLayout()
            _widget = QWidget()
            _ndl_22_widget = LabelGrid(
                data=_ndl_table, has_header=True, set_labels_bold=False, colors=_colors
            )
            _method_str = self.resources[
                "d" + str(dcf) + "_option" + str(chart_method) + "_str"
            ]
            ...
            v_layout = QVBoxLayout()
            _widget = QWidget()
            _ndl_64_widget = LabelGrid(
                data=_ndl_table, has_header=False, set_labels_bold=False, colors=_colors
            )
            _method_str = self.resources[
                "d" + str(dcf) + "_option" + str(chart_method) + "_str"
            ]
        ...
        for planet1, [index, (planet2, h, enemy)] in _paachakaadi_dict.items():
            ...
            _paachakaadi_info += (
                p2_str + " " + e_str + " " + p_str + " " + p1_str + " " + h_str + "<br>"
            )
        _paachakadi_menu_dict = {}
        if _paachakaadi_info.strip() != "":
            _paachakadi_menu_dict = {
                self.resources["paachakaadi_sambhandha_str"]: _paachakaadi_info
            }
        ...
        _brahma = house.brahma(planet_positions)
        _rudra = house.rudra(planet_positions)
        _brahma_menu_dict = {}
        _maheshwara = house.maheshwara_from_planet_positions(planet_positions)
        if _brahma and _rudra and _maheshwara:
            _brahma_info = (
                self.resources["brahma_str"]
                + ":"
                + utils.PLANET_NAMES[_brahma]
                + "<br>"
            )
            _brahma_info += (
                self.resources["rudra_str"]
                + ":"
                + utils.PLANET_NAMES[_rudra[0]]
                + " "
                + self.resources["raasi_str"]
                + ":"
                + utils.RAASI_LIST[_rudra[1]]
                + "<br>"
                + self.resources["trishoola_str"]
                + " "
                + self.resources["raasi_str"]
                + ":"
                + utils.RAASI_LIST[_rudra[2][0]]
                + ","
                + utils.RAASI_LIST[_rudra[2][1]]
                + ","
                + utils.RAASI_LIST[_rudra[2][2]]
                + "<br>"
            )
            _brahma_info += (
                self.resources["maheshwara_str"] + ":" + utils.PLANET_NAMES[_maheshwara]
            )
            _brahma_menu_dict = {
                utils.resource_strings["brahma_str"]
                + ","
                + utils.resource_strings["rudra_str"]
                + ","
                + utils.resource_strings["maheshwara_str"]: _brahma_info
            }

        _prasna_menu_dict = {
            self.resources["prasna_lagna_str"]
            + "("
            + self.resources["prasna_lagna_short_str"]
            + ")": vl_chart
        }
        _planets_menu_dict = {self.resources["planets_str"]: vl_chart}
        key = (
            utils.resource_strings["planets_str"]
            + " "
            + utils.resource_strings["speed_str"]
            + ", "
            + utils.resource_strings["distance_str"]
            + " "
            + utils.resource_strings["information_str"]
        )
        ...
        _planets_info_table.setHorizontalHeaderItem(
            0, QTableWidgetItem(utils.resource_strings["longitude_str"])
        )
        _planets_info_table.setHorizontalHeaderItem(
            1,
            QTableWidgetItem(
                utils.resource_strings["longitude_str"]
                + "\n"
                + utils.resource_strings["speed_str"]
            ),
        )
        _planets_info_table.setHorizontalHeaderItem(
            2, QTableWidgetItem(utils.resource_strings["latitude_str"])
        )
        _planets_info_table.setHorizontalHeaderItem(
            3,
            QTableWidgetItem(
                utils.resource_strings["latitude_str"]
                + "\n"
                + utils.resource_strings["speed_str"]
            ),
        )
        _planets_info_table.setHorizontalHeaderItem(
            4, QTableWidgetItem(utils.resource_strings["distance_str"])
        )
        _planets_info_table.setHorizontalHeaderItem(
            5,
            QTableWidgetItem(
        ...
        for p, s_p in psi.items():
            ...
            s_p = [
                round(s_p_p, 8) if i == len(psi) - 1 else round(s_p_p, 4)
                for i, s_p_p in enumerate(s_p)
            ]
            _planets_info_table.setVerticalHeaderItem(
                p, QTableWidgetItem(utils.PLANET_NAMES[p_i])
            )
            _planets_info_table.setItem(p, 0, QTableWidgetItem(str(s_p[0]) + " deg"))
            _planets_info_table.setItem(
                p, 1, QTableWidgetItem(str(s_p[3]) + " deg/day")
            )
            _planets_info_table.setItem(p, 2, QTableWidgetItem(str(s_p[1]) + " deg"))
            _planets_info_table.setItem(
                p, 3, QTableWidgetItem(str(s_p[4]) + " deg/day")
            )
        ...
        _planets_info_table.setEditTriggers(
            QAbstractItemView.EditTrigger.NoEditTriggers
        )
        ...
        if len(pa) > 0:
            _pushkara_info += (
                utils.resource_strings["pushkara_amsa_str"]
                + " "
                + utils.resource_strings["planets_str"]
                + ": <br>"
            )
        ...
        if len(pb) > 0:
            _pushkara_info += (
                "<br>"
                + utils.resource_strings["pushkara_bhaga_str"]
                + " "
                + utils.resource_strings["planets_str"]
                + ":<br>"
            )
        ...
        if chart_index == 0:
            ...
            if len(_yudh_planets) > 0:
                ...
                for (planet1, planet2, gy_type) in _yudh_planets:
                    _yudh_info += (
                        "<br>"
                        + utils.PLANET_NAMES[planet1]
                        + " "
                        + yudh_types[gy_type]
                        + " "
                        + utils.PLANET_NAMES[planet2]
                    )
                _grahayudh_dict = {self.resources["graha_yudh_str"]: _yudh_info}
        _mrityu_info = ""
        _mrityu_dict = {}
        _mrityu_planets = charts.planets_in_mrityu_bhaga(
            dob, tob, place, planet_positions
        )
        if len(_mrityu_planets) > 0:
            # _mrityu_dict = {self.resources['mrityu_bhaga_str']:vl_chart}
            _mrityu_info += (
                self.resources["mrityu_bhaga_str"]
                + " "
                + self.resources["planets_str"]
                + " :"
            )
            for p, r, l in _mrityu_planets:
                pstr = (
                    ...
                    if isinstance(p, int)
                        ...
                        self.resources["ascendant_str"]
                        if p == "L"
                        else self.resources["maandi_str"]
                    )
                )
                _mrityu_info += (
                    "<br>"
        ...
        rows = 9
        _aspect_values = [
            [str(ele) for ele in row]
            for row in strength.planet_aspect_relationship_table(
                planet_positions, include_houses=include_houses
            )
        ]
        ...
        _aspect_colors = [
            [
                _planet_relation_colors[crp[p1][p2] + crp_i]
                if p1 < 9
                else _rasi_relation_colors[hsp[p2][p1 - 9]]
                for p1 in range(rows)
            ]
            for p2 in range(9)
        ]  # +1 to crp if h_to_p used
        ...
        _legends = [
            [
                self.resources["adhisathru_str"] + " / " + self.resources["neecha_str"],
                self.resources["sathru_str"],
                self.resources["sama_str"],
            ],
            [
                self.resources["sama_str"],
                self.resources["mithra_str"] + " / " + self.resources["uchcha_str"],
                self.resources["adhimitra_str"]
                + " / "
                + self.resources["swagraha_str"],
            ],
        ]
        v_layout = QVBoxLayout()
        gl = QGridLayout()
        ...
        for r in range(2):
            for c in range(3):
                ...
                lbl.setStyleSheet(
                    "font-weight:bold; color:" + _rasi_relation_colors[clr]
                )
                gl.addWidget(lbl, r, c)
                clr += 1
        v_layout.addWidget(
            LabelGrid(data=_aspect_values, colors=_aspect_colors, label_font_size=12)
        )
        _widget = QWidget()
        ...
        mks_planets = charts.get_planets_in_marana_karaka_sthana(
            planet_positions, consider_ketu_4th_house=True
        )
        _mks_menu_dict = {}
        _mks_info = ""
        if len(mks_planets) > 0:
            key = (
                self.resources["marana_karaka_sthana_str"]
                + " "
                + self.resources["planets_str"]
            )
            _mks_info += key
        ...
        if chart_index != _mixed_chart_index:
            ...
            for p in ["L"]:  # +[*range(9)]:
                ...
                _rasi_entry_info += (
                    pstr
                    + " "
                    + self.resources["next_str"]
                    + " "
                    + self.resources["raasi_str"]
                    + " ("
                    + utils.RAASI_LIST[int(round(al / 30, 0)) % 12]
                    + ") "
                    + self.resources["entry_str"]
                    + " : ("
                    + str(ay)
                    + ","
                    + str(am)
        ...
        _nava_thaara_dict = {}
        _nava_thaara_widgets = None
        _spl_thaara_dict = {}
        _spl_thaara_widgets = None
        _special_thaara_dict = {}
        _special_thaara_widgets = None
        if chart_index == 0:  # Only for Raasi
            ...
            _gd_info = [
                ...
                if gpt == 0
                    ...
                    utils.PLANET_NAMES[p],
                    self.resources[const.graha_drekkana_types[gpt] + "_str"],
                ]
            ...
            v_layout = QVBoxLayout()
            v_layout.addWidget(
                QLabel(key + " (" + self.resources["ascendant_str"] + ")")
            )
            _star_list = utils.NAKSHATRA_LIST
            _nava_colors = [
                ["green", "brown", "blue", "blue", "blue"] for _ in range(len(_navas))
            ]
            ...
            _spl_info = [
                [self.resources[_spls[s]]]
                + [utils.PLANET_NAMES[lord], _star_list[star]]
        ...
        _arudha_menu_dict = {
            self.resources["arudhas_str"]: self._horo._arudha_menu_dict
        }
        ...
        return (
            _special_menu_dict_1d_chart,
            _drishti_table_widgets,
            _planets_info_table,
            _aspect_widgets,
            _ndl_22_widgets,
            _ndl_64_widgets,
            _graha_drekkana_widgets,
            _nava_thaara_widgets,
            _spl_thaara_widgets,
        )

    def _update_tabs_with_divisional_charts(
        self,
        jd,
        place,
        chart_index=None,
        ...
        if chart_index == _mixed_chart_index:
            (
                ...
                self._kundali_chart,
                self._kundali_ascendant_house,
            ) = self._horo.get_horoscope_information_for_mixed_chart(
                chart_index_1=chart_index_1,
                chart_method_1=chart_method_1,
                chart_index_2=chart_index_2,
                chart_method_2=chart_method_2,
                varnada_method=self._varnada_method_index,
            )
        else:
        ...
        special_lagna_count = len(const._special_lagna_list)
        total_row_count = (
            _arudha_lagnas_count + planet_count + upagraha_count + special_lagna_count
        )
        """ update the chart from horoscope charts """
        _chart_title = (
            tab_name
            + _chart_title_separator
            + self._date_text_years
            + _chart_title_separator
            + self._time_text_years
            + _chart_title_separator
            + self._timezone_text
            + _chart_title_separator
            + self._place_name
            + _chart_title_separator
            + self._lat_chart_text
            + " , "
            + self._long_chart_text
        )
        self.tabWidget.setTabText(
            _tabcount_before_chart_tab, tab_name.replace("\n", "-")
        )
        ...
        if self._western_chart:
            i_start = (
                i_start + special_lagna_count + _arudha_lagnas_count + 2
            )  # 2=>VL and Md
        ...
        for (
            ...
            _kundali_info.items()
        ):  ##list(self._horoscope_info.items())[i_start:i_end]:
            i_i += 1
            k1 = k.split("-")[-1]
            v1 = v.split("-")[0]
        ...
        if self._western_chart:
            i_end += (
                upagraha_count - 1
            )  # if const.include_maandhi_in_charts else upagraha_count
        chart_info_list = chart_info.split("\n")
        chart_info_count = len(chart_info_list)
        chart_info_count_half = int(chart_info_count / 2)
        chart_info1 = "\n".join(chart_info_list[:chart_info_count_half])
        chart_info2 = "\n".join(chart_info_list[chart_info_count_half:])
        self._chart_info_label1.setText(chart_info1)
        self._chart_info_label1.adjustSize()
        self._chart_info_label1.setMaximumWidth(
            _chart_info_label_width
        )  # Fixed defect here in 1.0.2
        self._chart_info_label2.setText(chart_info2)
        self._chart_info_label2.adjustSize()
        self._chart_info_label2.setMaximumWidth(
            _chart_info_label_width
        )  # Fixed defect here in 1.0.2
        chart_data_1d = self._kundali_chart  # self._horoscope_charts[t]
        chart_data_1d = [
            x.strip() for x in chart_data_1d
        ]  # remove \n from end of each element
        hl = self._horo._hora_lagna_data_kundali
        gl = self._horo._ghati_lagna_data_kundali
        vl = self._horo._vighati_lagna_data_kundali
        bl = self._horo._bhava_lagna_data_kundali
        ...
        if const.include_special_and_arudha_lagna_in_charts:
            for k, v in enumerate(self._horo._arudha_lagna_data_kundali):
                ...
                if (
                    k in bl.values()
                    and self.resources["bhava_lagna_short_str"] not in v1
                ):
                    v1 += "\n" + self.resources["bhava_lagna_short_str"]  # V3.1.9
                if (
                    k in sl.values()
                    and self.resources["sree_lagna_short_str"] not in v1
                ):
                    v1 += "\n" + self.resources["sree_lagna_short_str"]  # V3.1.9
                if (
                    k in hl.values()
                    and self.resources["hora_lagna_short_str"] not in v1
                ):
                    v1 += "\n" + self.resources["hora_lagna_short_str"]
                if (
                    k in gl.values()
                    and self.resources["ghati_lagna_short_str"] not in v1
                ):
                    v1 += "\n" + self.resources["ghati_lagna_short_str"]
                if (
                    k in vl.values()
                    and self.resources["vighati_lagna_short_str"] not in v1
                ):
                    v1 += "\n" + self.resources["vighati_lagna_short_str"]
                if not self._western_chart:
                    if (
                        const.include_maandhi_in_charts
                        and k in ml.values()
                        and self.resources["maandi_str"] not in v1
                    ):
                        v1 += "\n" + self.resources["maandi_str"]
                adc.append(v1.strip())
        ...
        if "north" in self._chart_type.lower():
            ...
            self._kundali_charts[0].setData(
                ...
                ndl_22_widgets=_ndl_22_widgets,
                ndl_64_widgets=_ndl_64_widgets,
            ...
            chart_data_2d = utils._convert_1d_house_data_to_2d(
                chart_data_1d, self._chart_type
            )
            row, col = const._asc_house_row_col__chart_map[
                self._kundali_ascendant_house
            ]
            arudha_lagna_data_2d = utils._convert_1d_house_data_to_2d(
                self._horo._arudha_lagna_data_kundali, self._chart_type
            )
            self._kundali_charts[0]._asc_house = (
                row * self._kundali_charts[0].row_count + col
            )
            self._kundali_charts[0].setData(
                chart_data_2d,
                chart_title=_chart_title,
            ...
            self._kundali_charts[0].setData(
                western_data,
                chart_title=_chart_title,
                chart_title_font_size=west_chart_title_font_size,
            )
            ...
            self._kundali_charts[0].setData(
                data_1d,
                chart_title=_chart_title,
                chart_title_font_size=sudarsana_chakra_chart_title_font_size,
            )
            self._kundali_charts[0].update()
        else:  # south indian'
            ...
            arudha_lagna_data_2d = utils._convert_1d_house_data_to_2d(
                self._horo._arudha_lagna_data_kundali
            )
    ...
    def _update_pps_tab_information(self):
        ...
        bird_index = pancha_paksha.pancha_pakshi_stars_birds_paksha[bs - 1][
            paksha_index - 1
        ]
        ...
        (
            ...
            dob, tob, place, nakshathra_bird_index=bird_index
        )
        self._pps_tree.bird_combo.clear()
        self._pps_tree.bird_combo.addItems(
            [self.resources[b + "_str"] for b in pancha_paksha.pancha_pakshi_birds]
        )
        self._pps_tree.bird_combo.setCurrentIndex(bird_index - 1)
        self._pps_tree.populate_tree(
            bird_index,
            headers,
            top_level_list,
            child_level_list,
        ...
        self.tabWidget.setTabText(
            _tabcount_before_chart_tab - 1, self.resources["pancha_pakshi_sastra_str"]
        )
    ...
    def _update_bhava_chart_information(self):
        ...
        place = self._horo.Place
        (
            self._bhava_chart_data,
            self._bhava_chart_info,
        ) = self._horo.get_bhava_chart_information(
            jd, place, self._bhaava_madhya_method
        )
        ...
        data = [
            ["" for _ in range(self._bhava_table_columns)]
            for _ in range(self._bhava_table_rows)
        ]
        ...
        chart_data_1d = [
            x[:-1] for x in chart_data_1d
        ]  # remove ]n from end of each element
        # self._western_chart = False
        if "north" in self._bhava_chart_type.lower():
            ...
            chart_1d = sudharsana_chakra.sudharshana_chakra_chart(
                jd, place, self._date_of_birth, years_from_dob=0
            )
            data_1d = self._convert_1d_chart_with_planet_names(chart_1d)
            self._bhava_chart.setData(
                data_1d,
    ...
    def _update_tab_chart_information(
        self,
        chart_index=None,
        chart_method=None,
        divisional_chart_factor=None,
        ...
        self._fill_panchangam_info(info_str, format_str)
        jd = (
            self._horo.julian_day
        )  # For ascendant and planetary positions, dasa bukthi - use birth time
        place = drik.Place(
            self._place_name,
            float(self._latitude),
            float(self._longitude),
        ...
        self._update_tabs_with_divisional_charts(
            jd,
            place,
            chart_index=chart_index,
            chart_method=chart_method,
    ...
    def _update_table_tab_information(
        self,
        tab_title_str,
        tab_start,
        tab_count,
        ...
        for db_tab in range(tab_count):
            ...
            for col in range(tables_per_tab):
                ...
                if dhasa_bhukti:
                    db_str = (
                        db_list[0][0].split("-")[0] + " " + self.resources["dhasa_str"]
                    )
                    db_tables[db_tab][col].setHorizontalHeaderItem(
                        0,
                        QTableWidgetItem(
                    ...
                    db_tables[db_tab][col].setHorizontalHeaderItem(
                        0, QTableWidgetItem(table_titles[table_index])
                    )
                t_row = 0
                for k, v in db_list:
                    k1 = k
                    ...
                    db_tables[db_tab][col].setVerticalHeaderItem(
                        t_row, QTableWidgetItem(str(k1))
                    )
                    db_tables[db_tab][col].setItem(t_row, 0, QTableWidgetItem(str(v)))
                    t_row += 1
                p = i_end
                table_index += 1
                db_tables[db_tab][col].horizontalHeader().setStyleSheet(
                    "QHeaderView { font-weight: bold }"
                )
                db_tables[db_tab][col].verticalHeader().setStyleSheet(
                    "QHeaderView { font-weight: bold }"
                )
                db_tables[db_tab][col].verticalHeader().setSectionResizeMode(
                    QHeaderView.ResizeMode.ResizeToContents
                )
                db_tables[db_tab][col].horizontalHeader().setSectionResizeMode(
                    QHeaderView.ResizeMode.ResizeToContents
                )
            tab_text = tab_title + "-" + str(db_tab + 1) if tab_count > 1 else tab_title
            self.tabWidget.setTabText(tab_start + db_tab, tab_text)

    def _update_amsa_ruler_tab_information(
        self,
        chart_index=1,
        chart_method=1,
        divisional_chart_factor=None,
        ...
        tab_str, _chart_title_separator = self._get_tab_chart_prefix()
        self.tabWidget.setTabText(
            _amsa_ruler_tab_start, tab_str + self.resources["amsa_ruler_str"]
        )
        _ar_keys = list(const.amsa_rulers.keys())
        ...
        (
            ...
            self._horo.Place,
            ayanamsa_mode=self._ayanamsa_mode,
            divisional_chart_factor=self._amsa_ruler_dcf,
            chart_method=chart_method,
            include_special_lagnas=_amsa_include_special_lagna,
            include_upagrahas=_amsa_include_upagraha,
            include_sphutas=_amsa_include_sphuta,
            base_rasi=base_rasi,
            count_from_end_of_sign=count_from_end_of_sign,
        )
    ...
    def _update_chakra_tab_information(
        self,
        chart_index=None,
        chart_method=None,
        divisional_chart_factor=None,
        ...
        if _chakra_type_index == 0:
            ...
            widget.setData(
                ...
                birth_star_padha=birth_star_padha,
                planets_in_retrograde=planets_in_retrograde,
                label_font_size=_chakra_label_font_size,
            )
            kota_lord = widget._kota_lord
            kota_paala = widget._kota_paala
            self._chakra_info_label.setVisible(True)
            self._chakra_info_label.setText(
                self.resources["kota_swami_str"]
                + " : "
                + kota_lord
                + " "
                + self.resources["kota_paala_str"]
                + " : "
                + kota_paala
            )
    ...
    def _update_kpinfo_information(
        self,
        chart_index=None,
        chart_method=None,
        divisional_chart_factor=None,
        ...
        self._kpinfo_table.horizontalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        self._kpinfo_table.verticalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        for c, col_str in enumerate(
            ["KP " + self.resources["number_str"]]
            + [
                self.resources[r]
                for r in [
                    "nakshatra_lord_str",
                    "sub_lord_str",
                    "prathyanthara_lord_str",
                    "sookshma_lord_str",
                    "praana_lord_str",
                    "deha_lord_str",
                ]
        ...
        for r, (p, kp_details) in enumerate(kp_info.items()):
            ...
            for c in range(col_count):
                col_str = (
                    str(kp_details[c]) if c == 0 else utils.PLANET_NAMES[kp_details[c]]
                )
        ...
        bhava_info = charts._bhaava_madhya_new(
            jd, place, planet_positions=planet_positions, bhava_madhya_method=1
        )
        h = 1
            ...
            for pStr, kp_details in kp_info.items():
                for c in range(col_count):
                    col_str = (
                        str(kp_details[c])
                        if c == 0
                        else utils.PLANET_NAMES[kp_details[c]]
                    )
    ...
    def _update_sphuta_tab_information(
        self,
        chart_index=None,
        method_index=None,
        varnada_method_index=1,
        divisional_chart_factor=None,
        base_rasi=None,
        count_from_end_of_sign=None,
        chart_index_1=None,
        ...
        if divisional_chart_factor == None:
            ...
            self._varnada_method_index = (
                self._varnada_varga_dict[dcf]
                if dcf in const.division_chart_factors
                else self._varnada_varga_dict[const.DEFAULT_CUSTOM_VARGA_FACTOR]
            )
        tab_str, _chart_title_separator = self._get_tab_chart_prefix()
        tab_str += (
            self.resources["sphuta_str"] + "-" + self.resources["varnada_lagna_str"]
        )
        if chart_index == _custom_chart_index:
            tab_title_str = tab_str + "-" + "D" + str(dcf)
        elif chart_index == _mixed_chart_index:
        ...
        self._varnada_option_button.setText(
            self.resources["varnada_lagna_str"] + " " + self.resources["options_str"]
        )
        self._varnada_option_info_label.setText(
            _varnada_method_options[self._varnada_method_index - 1]
        )
        ...
        place = self._horo.Place
        if chart_index == _mixed_chart_index:
            _sphuta_values = self._horo._get_sphuta_mixed_chart(
                dob,
                tob,
                place,
                varga_factor_1=v1,
            ...
            _sphuta_values = self._horo._get_sphuta(
                dob,
                tob,
                place,
                divisional_chart_factor=dcf,
        ...
        self._sphuta_table.horizontalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        self._sphuta_table.setHorizontalHeaderItem(
            0, QTableWidgetItem(self.resources["sphuta_str"])
        )
        self._sphuta_table.setHorizontalHeaderItem(
            1, QTableWidgetItem(self.resources["raasi_str"])
        )
        ...
        self._sphuta_table.resizeColumnToContents(0)
        self._sphuta_table.resizeColumnToContents(1)
        self._varnada_table.horizontalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        self._varnada_table.setHorizontalHeaderItem(
            0, QTableWidgetItem(self.resources["varnada_lagna_str"])
        )
        self._varnada_table.setHorizontalHeaderItem(
            1, QTableWidgetItem(self.resources["raasi_str"])
        )
        for h in range(12):
            if chart_index == _mixed_chart_index:
                vl = charts.varnada_lagna_mixed_chart(
                    dob,
                    tob,
                    place,
                    house_index=h + 1,
            ...
            _value = (
                utils.RAASI_LIST[vl[0]] + " " + utils.to_dms(vl[1], is_lat_long="plong")
            )
            self._varnada_table.setItem(h, 1, QTableWidgetItem(_value))
        self._varnada_table.resizeColumnToContents(0)
        self._varnada_table.resizeColumnToContents(1)
        return

    def _update_graha_arudha_tab_information(
        self,
        chart_index=None,
        chart_method=None,
        divisional_chart_factor=None,
        ...
        self._bhava_arudha_label1.setText(
            "<b>" + self.resources["graha_arudha_str"] + "</b>"
        )
        ...
        self._graha_arudha_table.resizeColumnToContents(0)
        self._graha_arudha_table.resizeColumnToContents(1)
        self._bhava_arudha_label2.setText(
            "<b>" + self.resources["bhava_arudha_str"] + "</b>"
        )
        _bhava_arudha_base_index = self._bhava_arudha_combo.currentIndex()
        ba = arudhas.bhava_arudhas_from_planet_positions(
            planet_positions, arudha_base=_bhava_arudha_base_index
        )
        for b in range(len(ba)):
            if _bhava_arudha_base_index == 0:
                self._bhava_arudha_table.setItem(
                    b,
                    0,
                    QTableWidgetItem(
                        self.resources["bhava_arudha_a" + str(b + 1) + "_str"]
                    ),
                )
            else:
                self._bhava_arudha_table.setItem(
                    ...
                    0,
                    QTableWidgetItem(
                        utils.PLANET_NAMES[_bhava_arudha_base_index - 1]
                        + "-"
                        + str(b + 1)
                    ),
                )
            self._bhava_arudha_table.setItem(
                b, 1, QTableWidgetItem(utils.RAASI_LIST[ba[b]])
            )
        self._bhava_arudha_table.resizeColumnToContents(0)
        self._bhava_arudha_table.resizeColumnToContents(1)
        return
    ...
    def _update_vimsopaka_bala_tab_information(self):
        ...
        table_info = [
            (k, v) for dbl in self._vimsopaka_bala_info for k, v in dbl.items()
        ]
        db_tables = self.vimsopaka_bala_db_tables
        table_titles = [
            self.resources[t] + "\n" + self.resources["vimsopaka_score_str"]
            for t in [
                "shadvarga_bala_str",
                "sapthavarga_bala_str",
                "dhasavarga_bala_str",
                "shodhasavarga_bala_str",
            ]
        ]
        self._update_table_tab_information(
            tab_title_str,
            tab_start,
            tab_count,
            rows_per_table,
    ...
    def _update_vaiseshikamsa_bala_tab_information(self):
        ...
        table_info = [
            (k, v) for dbl in self._vaiseshikamsa_bala_info for k, v in dbl.items()
        ]
        db_tables = self.vaiseshikamsa_bala_db_tables
        table_titles = [
            self.resources[t] + "\n" + self.resources["vaiseshikamsa_score_str"]
            for t in [
                "shadvarga_bala_str",
                "sapthavarga_bala_str",
                "dhasavarga_bala_str",
    ...
    def _update_other_bala_tab_information(self):
        tab_str, _chart_title_separator = self._get_tab_chart_prefix()
        tab_title_str = (
            tab_str + self.resources["harsha_pancha_dwadhasa_vargeeya_bala_str"]
        )
        ...
        table_titles = [
            ...
            for t in [
                "harsha_bala_str",
                "pancha_vargeeya_bala_str",
                "dwadhasa_vargeeya_bala_str",
            ]
        ]
        self._update_table_tab_information(
            tab_title_str,
    ...
    def _update_dhasa_bhukthi_tab_information(self):
        if self._western_chart or self._horo == None:
            return
        """ TODO: Should we change dob,tob to birth date/time here """
        dob = self._horo.Date
        tob = self._horo.birth_time
        ...
        if self._current_dhasa_type_index == 0:  # Graha Dhasa
            ...
            """
            if self._current_dhasa_index >= len(_graha_dhasa_dict):
                self._current_dhasa_index = 0
            self._dhasa_combo.setCurrentIndex(self._current_dhasa_index)
            tab_str, tab_values = list(_graha_dhasa_dict.items())[
                self._current_dhasa_index
            ]
            ...
            if self._current_dhasa_index >= len(_rasi_dhasa_dict):
                self._current_dhasa_index = 0
            tab_str, tab_values = list(_rasi_dhasa_dict.items())[
                self._current_dhasa_index
            ]
            retval = eval(
                "self._horo._get_"
            ...
            if self._current_dhasa_index >= len(_annual_dhasa_dict):
                self._current_dhasa_index = 0
            tab_str, tab_values = list(_annual_dhasa_dict.items())[
                self._current_dhasa_index
            ]
            _db_info = self._horo._get_annual_dhasa_bhukthi(divisional_chart_factor=dcf)
    ...
    def _update_shad_bala_table_information(self):
        ...
        for row in range(row_count):
            ...
            self._shad_bala_table[0].setVerticalHeaderItem(
                row, QTableWidgetItem(shad_str)
            )
            self._shad_bala_table[0].resizeRowToContents(row)
        for col in range(col_count):
            header = column_names[col]
            self._shad_bala_table[0].setHorizontalHeaderItem(
                col, QTableWidgetItem(header)
            )
            self._shad_bala_table[0].resizeColumnToContents(col)
        self._shad_bala_table[0].horizontalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        self._shad_bala_table[0].verticalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
    ...
    def _update_bhava_bala_table_information(self):
        ...
        column_names = [
            "bhava_bala_str",
            "bhava_bala_rupas_str",
            "bhava_bala_strength_str",
        ]
        ...
        for row in range(row_count):
            for col in range(col_count):
                cell_value = str(_sb_info[row][col])
                self._bhava_bala_table[0].setItem(
                    row, col, QTableWidgetItem(cell_value)
                )
        for row in range(row_count):
            bhava_str = row_names[row]
            self._bhava_bala_table[0].setVerticalHeaderItem(
                row, QTableWidgetItem(bhava_str)
            )
            self._bhava_bala_table[0].resizeRowToContents(row)
        for col in range(col_count):
            header = self.resources[column_names[col]]
            self._bhava_bala_table[0].setHorizontalHeaderItem(
                col, QTableWidgetItem(header)
            )
            self._bhava_bala_table[0].resizeColumnToContents(col)
        self._bhava_bala_table[0].horizontalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        self._bhava_bala_table[0].verticalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )

    def _update_argala_table_information(
        self,
        chart_index=None,
        chart_method=None,
        divisional_chart_factor=None,
        ...
        tab_str, _chart_title_separator = self._get_tab_chart_prefix()
        tab_str += (
            self.resources["argala_str"] + "-" + self.resources["virodhargala_str"]
        )
        if chart_index == _custom_chart_index:
            tab_title_str = tab_str + "-" + "D" + str(dcf)
        elif chart_index == _mixed_chart_index:
        ...
        if chart_index == _mixed_chart_index:
            _, chart_1d, _ = self._horo.get_horoscope_information_for_mixed_chart(
                chart_index_1=chart_index_1,
                chart_method_1=chart_method_1,
                chart_index_2=chart_index_2,
                chart_method_2=chart_method_2,
            ...
            _, chart_1d, _ = self._horo.get_horoscope_information_for_chart(
                chart_index,
                chart_method,
                divisional_chart_factor=dcf,
                base_rasi=base_rasi,
        ...
        for row in range(row_count_1):
            for col in range(col_count):
                ...
                a_planets = "\n".join(
                    planet_names[int(p)]
                    for p in a_planets
                    if p.strip() != "" and p.strip() != const._ascendant_symbol
                )
        ...
        self._argala_table1.horizontalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        self._argala_table2.horizontalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        self._argala_table1.verticalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        self._argala_table2.verticalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )

    def _update_drishti_table_information(
        self,
        chart_index=None,
        chart_method=None,
        divisional_chart_factor=None,
        ...
        for row in range(row_count_2):
            ...
            col3 = join_str.join(
                [
                    planet_names[int(pl)]
                    for pl in r_app[row]
                    if pl != "" and pl != const._ascendant_symbol
                ]
            )
        ...
        headers = [
            self.resources["raasis_str"],
            self.resources["houses_str"],
            self.resources["planets_str"],
        ]
        for col in range(col_count):
            self._drishti_table1.setHorizontalHeaderItem(
                col, QTableWidgetItem(headers[col])
            )
            self._drishti_table2.setHorizontalHeaderItem(
                col, QTableWidgetItem(headers[col])
            )
            self._drishti_table1.resizeColumnToContents(col)
            self._drishti_table2.resizeColumnToContents(col)
        self._drishti_table1.horizontalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        self._drishti_table2.horizontalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        self._drishti_table1.verticalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        self._drishti_table2.verticalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )

    def _get_drishti_table_widgets(
        self,
        chart_index=None,
        chart_method=None,
        divisional_chart_factor=None,
        ...
        r_arp, r_ahp, r_app = house.raasi_drishti_from_chart(chart_1d_ind, "\n")
        g_arp, g_ahp, g_app = house.graha_drishti_from_chart(chart_1d_ind, "\n")
        _drishti_table1 = QTableWidget(7, 3)
        _drishti_table2 = QTableWidget(9, 3)
        ...
        _drishti_table1.horizontalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        _drishti_table2.horizontalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        _drishti_table1.verticalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        _drishti_table2.verticalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
    ...
    def _update_saham_table_information(
        self,
        chart_index=None,
        chart_method=None,
        divisional_chart_factor=None,
        ...
        _saham_info1 = dict(list(_saham_info.items())[:18])
        _saham_info2 = dict(list(_saham_info.items())[18:])
        row_count_1 = self._saham_table1.rowCount()
        row_count_2 = self._saham_table2.rowCount()
        col_count = self._saham_table1.columnCount()
        headers = [
            self.resources["saham_str"],
            self.resources["raasi_str"] + " " + self.resources["longitude_str"],
        ]
        for col in range(col_count):
            self._saham_table1.setHorizontalHeaderItem(
                col, QTableWidgetItem(headers[col])
            )
            self._saham_table2.setHorizontalHeaderItem(
                col, QTableWidgetItem(headers[col])
            )
        ...
        for row, (s1, s2) in enumerate(_saham_info1.items()):
            ...
            self._saham_table1.resizeColumnToContents(0)
            self._saham_table1.resizeColumnToContents(1)
        for row, (s1, s2) in enumerate(_saham_info2.items()):
            ...
            self._saham_table2.resizeColumnToContents(0)
            self._saham_table2.resizeColumnToContents(1)
        self._saham_table1.horizontalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        self._saham_table2.horizontalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        self._saham_table1.verticalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        self._saham_table2.verticalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
    ...
    def _get_saham_table_widgets(
        ...
        _saham_info1 = dict(list(_saham_info.items())[:18])
        _saham_info2 = dict(list(_saham_info.items())[18:])
        _saham_table1 = QTableWidget(18, 2)
        _saham_table2 = QTableWidget(18, 2)
        ...
        _saham_table1.horizontalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        _saham_table2.horizontalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        _saham_table1.verticalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        _saham_table2.verticalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        return [_saham_table1, _saham_table2]

    def _update_shodhaya_table_information(
        self,
        chart_index=None,
        chart_method=None,
        divisional_chart_factor=None,
        ...
        label_title = (
            self.resources["ashtaka_varga_str"]
            + " ("
            + self.resources["trikona_str"]
            + "-"
            + self.resources["ekadhipathya_str"]
            + " )"
        )
        ...
        raasi_pindas, graha_pindas, shodya_pindas = ashtakavarga._sodhya_pindas(
            eka, chart_1d
        )  # _en)
        ...
        for r in range(col_count):
            ...
            self._shodhaya_table1.setItem(
                row_count - 1, r, QTableWidgetItem(str(sav[r]))
            )
        ...
        self._shodhaya_table1.horizontalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        self._shodhaya_table1.verticalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        ...
        row_names = [
            self.resources["graha_pinda_str"],
            self.resources["raasi_pinda_str"],
            self.resources["shodhaya_pinda_str"],
        ]
        ...
        for row in range(row_count):
            self._shodhaya_table2.setVerticalHeaderItem(
                row, QTableWidgetItem(row_names[row])
            )
            self._shodhaya_table2.resizeRowToContents(row)
        for p in range(col_count):
            self._shodhaya_table2.setHorizontalHeaderItem(
                p, QTableWidgetItem(self._horo._get_planet_list()[0][p])
            )
            self._shodhaya_table2.resizeColumnToContents(p)
        self._shodhaya_table2.horizontalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        self._shodhaya_table2.verticalHeader().setStyleSheet(
            "QHeaderView { font-weight: bold }"
        )
        self._shodhaya_table2.update()

    def _update_ashtaka_varga_tab_information(
        self,
        chart_index=None,
        chart_method=None,
        divisional_chart_factor=None,
        ...
        tab_names = [
            self.resources[tab] for tab in _chart_names
        ]  # self.tabNames[_tabcount_before_chart_tab:_chart_tab_end]]#_vimsottari_dhasa_tab_start]]
        if divisional_chart_factor == None:
            if chart_index < _custom_chart_index:
                dcf = const.division_chart_factors[chart_index]
            else:
            ...
            for _ in range(3):
                if ac == 0:
                    ...
                    chart_title = (
                        self.resources["ascendant_str"]
                        if ac == 8
                        else self._horo._get_planet_list()[0][ac - 1]
                    )
                if (
                    "north" in self._chart_type.lower()
                    or "sudar" in self._chart_type.lower()
                ):
                    # _ascendant = drik.ascendant(jd,place)
                    asc_house = self._ashtaka_ascendant_house + 1  # _ascendant[0]+1
                    chart_data_north = (
                        chart_data_1d[asc_house - 1 :]
                        + chart_data_1d[0 : asc_house - 1]
                    )
                    ...
                    self._ashtaka_charts[ac]._asc_house = (
                        row * self._ashtaka_charts[ac].row_count + col
                    )
                    self._ashtaka_charts[ac].setData(
                        chart_data_2d,
                        chart_title=chart_title,
    ...
    def _update_prediction_tab_information(self):
        self.tabWidget.setTabText(
            _prediction_tab_start, self.resources["general_prediction_str"]
        )
        """ TODO: Should this be julian day, julian_years or birth-julian-day? """
        # jd = self._horo.julian_day  # For ascendant and planetary positions, dasa bukthi - use birth time
        jd = self._birth_julian_day
        ...
        self._prediction_results = general.get_prediction_details(
            jd, place, language=available_languages[self._language]
        )
    ...
    def _update_dosha_tab_information(self):
        ...
        self._dosha_results = dosha.get_dosha_details(
            jd, place, language=available_languages[self._language]
        )
        ...
        for k in range(list_count):
            if sy_len > k:
                ...
                (
                    ...
                    yoga_description,
                    yoga_predictions,
                ) = self._yoga_results[yk]
                yoga_results_text += (
                    "<b><u>" + yoga_name + " (" + yoga_chart + ")</u></b><br>"
                )
                yoga_results_text += (
                    "<b>"
                    + self.resources["description_str"]
                    + "</b> "
                    + yoga_description
                    + "<br>"
                )
    ...
    def _update_yoga_tab_information(self):
        ...
        self._raja_yoga_count = len(
            self._raja_yoga_results
        )  # ; print('found raja yogas',self._raja_yoga_count)
                ...
                for kk in range(_raja_yogas_per_list_item):
                    if k + kk <= yoga_count - kk:
                        key = (
                            ...
                            + "\n"
                            + "".join(
                                list(self._raja_yoga_results.values())[k + kk][
                                    1
                                ].split()[0:-1]
                            )
                        )
            ...
            for kk in range(_yogas_per_list_item):
                if k + kk <= yoga_count - kk:
                    key = (
                        ...
                        + "\n"
                        + "".join(
                            list(self._yoga_results.values())[k + kk][1].split()[0:-1]
                        )
                    )
            key = key[1:]
            self._yoga_list.addItem(QListWidgetItem(key))
        if self._raja_yoga_count > 0:
    ...
    def _update_compatibility_tab_information(self):
        self.tabWidget.setTabText(
            _compatibility_tab_start, self.resources["compatibility_str"]
        )
        bn = None
        bp = None
        gn = None
        ...
        _nakshatra_number = nak[0]
        _paadha_number = nak[1]
        ...
        comp = compatibility.Match(
            ...
            check_for_mahendra_porutham=self._mahendra_porutham,
            check_for_vedha_porutham=self._vedha_porutham,
            check_for_rajju_porutham=self._rajju_porutham,
            check_for_shreedheerga_porutham=self._sthree_dheerga_porutham,
            minimum_score=self._minimum_score,
            method=self._chart_type,
        )
        self._matching_stars_tuple = utils.sort_tuple(
            comp.get_matching_partners(), 3, reverse=True
        )
    ...
    def _update_compatibility_table_tmp(self, results_table, selected_list_index):
        ...
        ettu_poruthham_list = [
            self.resources[p] for p in compatibility.compatibility_list_north
        ]
        if "south" in self._chart_type.lower():
            ettu_poruthham_list = [
                self.resources[p] for p in compatibility.compatibility_list_south
            ]
        ettu_porutham_max_score = [
            compatibility.varna_max_score,
            compatibility.vasiya_max_score,
            compatibility.gana_max_score,
            compatibility.nakshathra_max_score,
            compatibility.yoni_max_score,
            compatibility.raasi_adhipathi_max_score,
            compatibility.raasi_max_score,
            compatibility.naadi_max_score,
        ]
        naalu_porutham_list = [
            self.resources[p] for p in compatibility.naalu_porutham_list
        ]
        ...
        paadham = (
            self.resources["paadham_str"] + " " + str(selected_matching_star_tuple[1])
        )
        results_table.setHorizontalHeaderItem(
            0, QTableWidgetItem(nakshatra + "-" + paadham)
        )
        ...
        for p, porutham in enumerate(ettu_poruthham_list):
            if "south" in self._chart_type.lower():
                ...
                results_table.setItem(
                    row, 1, QTableWidgetItem(str(ettu_porutham_results[p]))
                )
                results_table.setItem(row, 2, QTableWidgetItem("True"))
                if ettu_porutham_results[p]:
                    results_table.setItem(
                        row, 3, QTableWidgetItem(str(const._GREEN_CHECK))
                    )
                else:
                    results_table.setItem(
                        row, 3, QTableWidgetItem(str(const._RED_CROSS))
                    )
            else:
                results_table.setItem(row, 0, QTableWidgetItem(porutham))
                results_table.setItem(
                ...
                results_table.setItem(
                    row, 2, QTableWidgetItem(str(ettu_porutham_max_score[p]))
                )
                perc = "{:3.0f}%".format(
                    ettu_porutham_results[p] / ettu_porutham_max_score[p] * 100
                )
        ...
        for p, porutham in enumerate(naalu_porutham_list):
            results_table.setItem(row, 0, QTableWidgetItem(porutham))
            results_table.setItem(
                row, 1, QTableWidgetItem(str(naalu_porutham_results[p]))
            )
            results_table.setItem(row, 2, QTableWidgetItem("True"))
            ...
            row += 1
        results_table.setItem(
            row, 0, QTableWidgetItem(self.resources["overall_match_str"])
        )
        ...
        if "south" in self._chart_type.lower():
            results_table.setItem(
                row,
                2,
                QTableWidgetItem(str(compatibility.max_compatibility_score_south)),
            )
            ...
            results_table.setItem(
                row, 2, QTableWidgetItem(str(compatibility.max_compatibility_score))
            )
            perc = "{:3.0f}%".format(
                compatibility_score / compatibility.max_compatibility_score * 100
            )
            results_table.setItem(row, 3, QTableWidgetItem(str(perc)))
        results_table.setSizeAdjustPolicy(
            QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents
        )
    ...
    def _update_chart_ui_with_info(self):
        ...
        if not self._western_chart:
            ...
            self._update_saham_table_information(
                self._current_saham_chart_index, self._saham_method_index
            )
            self._update_drishti_table_information(
                self._current_drishti_chart_index, self._drishti_method_index
            )
            self._update_graha_arudha_tab_information(
                self._current_arudha_chart_index, self._arudha_method_index
            )
            ...
            self._current_ashtaka_chart_index = self._ashtaka_chart_combo.currentIndex()
            self._update_ashtaka_varga_tab_information(
                self._current_ashtaka_chart_index, self._ashtaka_method_index
            )
            self._update_argala_table_information(
                self._current_argala_chart_index, self._argala_method_index
            )
            self._update_shodhaya_table_information(
                self._current_shodhaya_chart_index, self._shodhaya_method_index
            )
    ...
    def save_as_pdf(self, pdf_file_name=None):
        ...
        def _scroll_and_capture_panchanga_info(
            image_id, image_files, image_prefix="pdf_grb_", image_ext=".png"
        ):
            import time
        ...
        def __save_scrollable_list_widget_as_image(
            widget: QWidget,
            image_id,
            image_files,
            _row_steps=1,
        ...
        if pdf_file_name:
            ...
            for t in range(self.tabCount):
                ...
                if t == 0:
                ...
                elif t == _chakra_tab_start:
                    image_id = __save_scrollable_list_widget_as_image(
                    ...
                    image_id = __save_scrollable_list_widget_as_image(
                        self._yoga_list, image_id, image_files
                    )
                elif t == _dosha_tab_start:
                    image_id = __save_scrollable_list_widget_as_image(
                        self._dosha_list, image_id, image_files
                    )
                    ...
                    image_id = __save_scrollable_list_widget_as_image(
                        ...
                        image_id,
                        image_files,
                        _comp_results_per_list_item,
                    )
                elif t == _prediction_tab_start:
                    image_id = __save_scrollable_list_widget_as_image(
                        self._prediction_list, image_id, image_files
                    )
                else:
                    image_file = _images_path + image_prefix + str(image_id) + image_ext
                    image_files.append(image_file)
    ...
    def _convert_language_chart_to_english(self, rasi_1d_lang):
        ...
        planet_lang_dict = {
            planet_list_lang[i]: planet_list_en[i] for i in range(len(planet_list_en))
        }
    ...
    def _convert_language_chart_to_indices(self, rasi_1d_lang):
        ...
        planet_lang_dict = {
            planet_list_en[i]: str(i) for i in range(len(planet_list_en))
        }
        ...
        for k, v in planet_lang_dict.items():
            for i, house in enumerate(rasi_1d_en):
                if k in house:
                    rasi_1d_en[i] = (
                        rasi_1d_en[i].replace(k, v).replace(const._retrogade_symbol, "")
                    )
        return rasi_1d_en
...
def _combine_multiple_images(
    image_list, output_image, combine_mode="vertical", image_quality_in_pixels=100
):
    total_width = 0
    total_height = 0
    max_width = 0

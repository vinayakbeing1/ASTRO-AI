...
def artha_saham(planet_positions, night_time_birth=False):
    ...
    long_second_lord = (
        planet_positions[second_lord + 1][1][0] * 30
        + planet_positions[second_lord + 1][1][1]
    )
    " A - B + C "
...
def karyasiddhi_saham(planet_positions, night_time_birth=False):
    ...
    lord_of_sun_sign = house.house_owner_from_planet_positions(
        planet_positions, planet_positions[1][1][0]
    )
    ...
    if night_time_birth:
        ...
        lord_of_moon_sign = house.house_owner_from_planet_positions(
            planet_positions, planet_positions[2][1][0]
        )
...
def laabha_saham(planet_positions, night_time_birth=False):
    ...
    eleventh_lord = house.house_owner_from_planet_positions(
        planet_positions, eleventh_house
    )
    long_asc_house = lagna_longitude(planet_positions)
    ...
    if not _is_C_between_B_to_A(
        long_eleventh_house, long_eleventh_lord, long_asc_house
    ):
        laabha_saham_long += 30
    if night_time_birth:
        laabha_saham_long = long_eleventh_lord - long_eleventh_house + long_asc_house
        if not _is_C_between_B_to_A(
            long_eleventh_lord, long_eleventh_house, long_asc_house
        ):
            laabha_saham_long += 30

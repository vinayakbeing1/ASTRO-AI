...
def tri_sphuta(
    ...
    gulika_long = gulika[0] * 30 + gulika[1]
    _tri_sphuta = (moon_long + asc_long + gulika_long) % 360
    return drik.dasavarga_from_long(
        _tri_sphuta, divisional_chart_factor=divisional_chart_factor
    )


def chatur_sphuta_mixed_chart(
    dob,
    tob,
    place,
    varga_factor_1=1,
    ...
    _tri_sphuta = tri_sphuta_mixed_chart(
        dob, tob, place, varga_factor_1, chart_method_1, varga_factor_2, chart_method_2
    )
...
def chatur_sphuta(
    ...
    _chatur_sphuta = (sun_long + _tri_sphuta[0] * 30 + _tri_sphuta[1]) % 360
    return drik.dasavarga_from_long(
        _chatur_sphuta, divisional_chart_factor=divisional_chart_factor
    )


def pancha_sphuta_mixed_chart(
    dob,
    tob,
    place,
    varga_factor_1=1,
    ...
    _chatur_sphuta = chatur_sphuta_mixed_chart(
        dob, tob, place, varga_factor_1, chart_method_1, varga_factor_2, chart_method_2
    )
...
def pancha_sphuta(
    ...
    _pancha_sphuta = (rahu_long + _chatur_sphuta[0] * 30 + _chatur_sphuta[1]) % 360
    return drik.dasavarga_from_long(
        _pancha_sphuta, divisional_chart_factor=divisional_chart_factor
    )


def prana_sphuta_mixed_chart(
    dob,
    tob,
    place,
    varga_factor_1=1,
...
def prana_sphuta(
    ...
    _prana_long = (asc_long * 5 + gulika_long) % 360
    return drik.dasavarga_from_long(
        _prana_long, divisional_chart_factor=divisional_chart_factor
    )


def deha_sphuta_mixed_chart(
    dob,
    tob,
    place,
    varga_factor_1=1,
...
def deha_sphuta(
    ...
    _deha_long = (moon_long * 8 + gulika_long) % 360
    return drik.dasavarga_from_long(
        _deha_long, divisional_chart_factor=divisional_chart_factor
    )


def mrityu_sphuta_mixed_chart(
    dob,
    tob,
    place,
    varga_factor_1=1,
...
def mrityu_sphuta(
    ...
    _mrityu_long = (gulika_long * 7 + sun_long) % 360
    return drik.dasavarga_from_long(
        _mrityu_long, divisional_chart_factor=divisional_chart_factor
    )


def sookshma_tri_sphuta_mixed_chart(
    dob,
    tob,
    place,
    varga_factor_1=1,
    ...
    jd_at_dob = utils.julian_day_number(dob, tob)
    mixed_dvf = varga_factor_1 * varga_factor_2
    _prana_long = prana_sphuta_mixed_chart(
        dob, tob, place, varga_factor_1, chart_method_1, varga_factor_2, chart_method_2
    )
    _deha_long = deha_sphuta_mixed_chart(
        dob, tob, place, varga_factor_1, chart_method_1, varga_factor_2, chart_method_2
    )
    _mrityu_long = mrityu_sphuta_mixed_chart(
        dob, tob, place, varga_factor_1, chart_method_1, varga_factor_2, chart_method_2
    )
    _sookshma_long = (
        _prana_long[0] * 30
...
def sookshma_tri_sphuta(
    ...
    return drik.dasavarga_from_long(
        _sookshma_long, divisional_chart_factor=divisional_chart_factor
    )


def beeja_sphuta_mixed_chart(
    dob,
    tob,
    place,
    varga_factor_1=1,
...
def beeja_sphuta(
    ...
    _beeja_long = (sun_long + jupiter_long + venus_long) % 360
    return drik.dasavarga_from_long(
        _beeja_long, divisional_chart_factor=divisional_chart_factor
    )


def kshetra_sphuta_mixed_chart(
    dob,
    tob,
    place,
    varga_factor_1=1,
...
def kshetra_sphuta(
    ...
    _kshetra_long = (moon_long + jupiter_long + mars_long) % 360
    return drik.dasavarga_from_long(
        _kshetra_long, divisional_chart_factor=divisional_chart_factor
    )


def tithi_sphuta_mixed_chart(
    dob,
    tob,
    place,
    varga_factor_1=1,
...
def tithi_sphuta(
    ...
    _tithi_long = (moon_long - sun_long) % 360
    return drik.dasavarga_from_long(
        _tithi_long, divisional_chart_factor=divisional_chart_factor
    )


def yoga_sphuta_mixed_chart(
    dob,
    tob,
    place,
    varga_factor_1=1,
...
def yoga_sphuta(
    ...
    _yoga_long = (moon_long + sun_long + yogi_long) % 360
    return drik.dasavarga_from_long(
        _yoga_long, divisional_chart_factor=divisional_chart_factor
    )


def yogi_sphuta_mixed_chart(
    dob,
    tob,
    place,
    varga_factor_1=1,
    ...
    return yoga_sphuta_mixed_chart(
        dob,
        tob,
        place,
        varga_factor_1,
...
def avayogi_sphuta_mixed_chart(
    dob,
    tob,
    place,
    varga_factor_1=1,
...
def rahu_tithi_sphuta_mixed_chart(
    dob,
    tob,
    place,
    varga_factor_1=1,
...
if __name__ == "__main__":
    ...
    ystr += (
        ...
        + utils.resource_strings["yogi_sphuta_str"]
        + " "
        + utils.resource_strings["nakshatra_str"]
        + ":"

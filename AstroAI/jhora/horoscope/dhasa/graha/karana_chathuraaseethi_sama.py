...
dhasa_adhipathi_dict = {
    key: const.karana_lords[key] for key in list(const.karana_lords.keys())[:-2]
}  # Exclude Rahu and Ketu V4.2.7
dhasa_adhipathi_list = {
    k: 12 for k in range(len(dhasa_adhipathi_dict))
}  # duration 12 years Total 84 years
count_direction = (

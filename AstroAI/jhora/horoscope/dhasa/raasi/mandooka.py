...
dhasa_order = {
    ...
    11: (
        [11, 2, 5, 8, 1, 4, 7, 10, 0, 3, 6, 9],
        [11, 8, 5, 2, 1, 10, 7, 4, 0, 9, 6, 3],
    ),
    ...
    10: (
        [10, 1, 4, 7, 0, 3, 6, 9, 2, 5, 8, 11],
        [10, 7, 4, 1, 0, 9, 6, 3, 2, 11, 8, 5],
    ),
}
...
def _dhasa_duration_kn_rao(planet_positions, sign):
    ...
    if (
        dhasa_period <= 0
        or const.house_strengths_of_planets[lord_of_sign][house_of_lord]
        == const._OWNER_RULER
    ):  # or \

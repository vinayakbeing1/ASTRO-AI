...
def get_dhasa_antardhasa(
    ...
    lord_of_arudha_sign = house.house_owner_from_planet_positions(
        planet_positions, arudha_sign
    )
    ...
    dhasa_seed_sign = house.stronger_rasi_from_planet_positions(
        navamsa_planet_positions, navamsa_arudha_sign, arudha_seventh_house
    )
